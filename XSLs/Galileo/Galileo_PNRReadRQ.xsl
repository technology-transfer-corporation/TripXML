...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<!-- ================================================================== -->
	<!-- Date: 25 Aug 2014 - Rastko	- added support for UpdateSessionedRQ								-->
				...
				<PNRAddr>
					...
					<RecLoc>
						<xsl:choose>
							...
							<xsl:when test="OTA_UpdateSessionedRQ/UniqueID/@ID != ''">
								<xsl:value-of select="OTA_UpdateSessionedRQ/UniqueID/@ID" />
							</xsl:when>
							<xsl:otherwise>
