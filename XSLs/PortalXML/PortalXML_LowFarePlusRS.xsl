	...
	<xsl:template match="ArrayOfPackage">
		<OTA_AirLowFareSearchPlusRS>
			...
			<xsl:variable name="adt">
				<xsl:choose>
					<xsl:when test="OTA_AirLowFareSearchPlusRQ/TravelerInfoSummary/AirTravelerAvail/PassengerTypeQuantity[@Code='ADT']/@Quantity!=''">
						<xsl:value-of select="OTA_AirLowFareSearchPlusRQ/TravelerInfoSummary/AirTravelerAvail/PassengerTypeQuantity[@Code='ADT']/@Quantity"/>
					</xsl:when>
			...
			<xsl:variable name="chd">
				<xsl:choose>
					<xsl:when test="OTA_AirLowFareSearchPlusRQ/TravelerInfoSummary/AirTravelerAvail/PassengerTypeQuantity[@Code='CHD']/@Quantity!=''">
						<xsl:value-of select="OTA_AirLowFareSearchPlusRQ/TravelerInfoSummary/AirTravelerAvail/PassengerTypeQuantity[@Code='CHD']/@Quantity"/>
					</xsl:when>
					<xsl:otherwise>0</xsl:otherwise>
				</xsl:choose>
			</xsl:variable>
			<xsl:variable name="yth">
				<xsl:choose>
					<xsl:when test="OTA_AirLowFareSearchPlusRQ/TravelerInfoSummary/AirTravelerAvail/PassengerTypeQuantity[@Code='YTH']/@Quantity!=''">
						<xsl:value-of select="OTA_AirLowFareSearchPlusRQ/TravelerInfoSummary/AirTravelerAvail/PassengerTypeQuantity[@Code='YTH']/@Quantity"/>
					</xsl:when>
					<xsl:otherwise>0</xsl:otherwise>
				</xsl:choose>
			</xsl:variable>
			<xsl:variable name="src">
				<xsl:choose>
					<xsl:when test="OTA_AirLowFareSearchPlusRQ/TravelerInfoSummary/AirTravelerAvail/PassengerTypeQuantity[@Code='SRC']/@Quantity!=''">
						<xsl:value-of select="OTA_AirLowFareSearchPlusRQ/TravelerInfoSummary/AirTravelerAvail/PassengerTypeQuantity[@Code='SRC']/@Quantity"/>
					</xsl:when>
					<xsl:otherwise>0</xsl:otherwise>
				</xsl:choose>
			</xsl:variable>
			<xsl:variable name="ins">
				<xsl:choose>
					<xsl:when test="OTA_AirLowFareSearchPlusRQ/TravelerInfoSummary/AirTravelerAvail/PassengerTypeQuantity[@Code='INS']/@Quantity!=''">
						<xsl:value-of select="OTA_AirLowFareSearchPlusRQ/TravelerInfoSummary/AirTravelerAvail/PassengerTypeQuantity[@Code='INS']/@Quantity"/>
					</xsl:when>
					<xsl:otherwise>0</xsl:otherwise>
				</xsl:choose>
			</xsl:variable>
			<xsl:variable name="inf">
				<xsl:choose>
					<xsl:when test="OTA_AirLowFareSearchPlusRQ/TravelerInfoSummary/AirTravelerAvail/PassengerTypeQuantity[@Code='INF']/@Quantity!=''">
						<xsl:value-of select="OTA_AirLowFareSearchPlusRQ/TravelerInfoSummary/AirTravelerAvail/PassengerTypeQuantity[@Code='INF']/@Quantity"/>
					</xsl:when>
					<xsl:otherwise>0</xsl:otherwise>
				</xsl:choose>
			</xsl:variable>
