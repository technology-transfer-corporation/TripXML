...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<!-- Date: 15 Jun 2010 - Rastko - moved Sabre AirPrice to version 1.13.1			-->
	<!-- Date: 16 Dec 2008 - Rastko														-->
	<!-- ================================================================== -->
	<xsl:output method="xml" omit-xml-declaration="yes" />
	<xsl:variable name="PCC"><xsl:value-of select="OTA_AirPriceRQ/POS/Source/@PseudoCityCode"/></xsl:variable>
	<xsl:variable name="NIP"><xsl:value-of select="OTA_AirPriceRQ/TravelerInfoSummary/SeatsRequested"/></xsl:variable>
	<xsl:template match="/">
		<AirPrice>
	...
	<xsl:template match="OTA_AirPriceRQ">
		...
		<Read>
			<OTA_TravelItineraryReadRQ Version="2003A.TsabreXML1.9.1" xmlns="http://webservices.sabre.com/sabreXML/2003/07">
				<POS>
					<Source>
	...
	<xsl:template match="AirItinerary">
		<OTA_AirBookRQ xmlns="http://webservices.sabre.com/sabreXML/2003/07" Version="2003A.TsabreXML1.2.1">
			<POS>
				<Source>
					<xsl:attribute name="PseudoCityCode">
						<xsl:value-of select="$PCC" />
