...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:template match="/">
		...
		<xsl:apply-templates select="SearchForPackagesResponse/SearchForPackagesResult/ResultData" />
	</xsl:template>
	...
	<xsl:template match="ResultData">
		<OTA_AirLowFareSearchPlusRS>
			...
			<Success></Success>
			<xsl:variable name="nip"><xsl:value-of select="AirRequest/AdultCount + AirRequest/ChildCount + AirRequest/YouthCount + AirRequest/SeniorCount + AirRequest/SeatedInfantCount"/></xsl:variable>
			<xsl:variable name="adt"><xsl:value-of select="AirRequest/AdultCount"/></xsl:variable>
			<xsl:variable name="chd"><xsl:value-of select="AirRequest/ChildCount"/></xsl:variable>
			<xsl:variable name="yth"><xsl:value-of select="AirRequest/YouthCount"/></xsl:variable>
			<xsl:variable name="src"><xsl:value-of select="AirRequest/SeniorCount"/></xsl:variable>
			<xsl:variable name="ins"><xsl:value-of select="AirRequest/SeatedInfantCount"/></xsl:variable>
			<xsl:variable name="inf"><xsl:value-of select="AirRequest/InfantCount"/></xsl:variable>
			<PricedItineraries>
