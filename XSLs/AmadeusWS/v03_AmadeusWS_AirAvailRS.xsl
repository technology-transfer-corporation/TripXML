...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt" xmlns:ttVB="urn:ttVB" exclude-result-prefixes="msxsl ttVB" version="1.0">
	...
	<!-- ================================================================== -->
	<!-- Date: 12 Feb 2012 - Rastko - added premium class								-->
	...
	<xsl:template match="flightInfo" mode="leg">
		...
		<FlightSegment>
			...
			<TPA_Extensions>
				...
				<xsl:if test="additionalFlightInfo/flightDetails/legDuration">
					<FlightDuration>
						<xsl:value-of select="substring(string(additionalFlightInfo/flightDetails/legDuration),1,2)"/>:<xsl:value-of select="substring(string(additionalFlightInfo/flightDetails/legDuration),3,2)"/>
					</FlightDuration>
				</xsl:if>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="Scenario1" userelativepaths="yes" externalpreview="no" url="file:///d:/Flight_Schedule/Air_Avail_v03/res1/lf/filter/res30.xml" htmlbaseurl=""
		          outputurl="file:///d:/Flight_Schedule/Air_Avail_v03/res1/lf/filter/test1.xml" processortype="saxon8" useresolver="yes" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath=""
