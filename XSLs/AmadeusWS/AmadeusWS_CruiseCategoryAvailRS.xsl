...
<!-- ================================================================== -->
<!-- AmadeusWS_CruiseCategoryAvailRS.xsl 	     								       -->
<!-- ================================================================== -->
...
<xsl:template match="/">
	<xsl:apply-templates select="Cruise_RequestCategoryAvailabilityReply" />
...
<xsl:template match="Cruise_RequestCategoryAvailabilityReply">
	<OTA_CruiseCategoryAvailRS Version="1.000">
		<xsl:choose>
