...
<!-- ================================================================== -->
<!-- AmadeusWS_CruisePackageDescRS.xsl 	     								       -->
<!-- ================================================================== -->
...
<xsl:template match="/">
	<xsl:apply-templates select="Cruise_DisplayPrePostPackageDescriptionReply" />
...
<xsl:template match="Cruise_DisplayPrePostPackageDescriptionReply">
