...
<!-- 
================================================================== 
 AmadeusWS_GenerateVirtualCardRS.xsl									
================================================================== 
...
-->
	...
	<xsl:template match="/">
		<xsl:apply-templates select="AMA_PAY_GenerateVirtualCardRS"/>
    <xsl:apply-templates select="PAY_GenerateVirtualCardRS"/>
	</xsl:template>
	<xsl:template match="PAY_GenerateVirtualCardRS | AMA_PAY_GenerateVirtualCardRS">
		<PAY_GenerateVirtualCardRS>
		  <xsl:if test="Errors">
		    <Errors>
