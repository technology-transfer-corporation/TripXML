		...
		<xsl:for-each select="OriginDestinationInformation">
			...
			<Air_MultiAvailability>
				...
				<requestSection>
					...
					<xsl:choose>
						<xsl:when test="../SpecificFlightInfo">
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="Scenario1" userelativepaths="yes" externalpreview="no" url="req.xml" htmlbaseurl="" outputurl="test1.xml" processortype="saxon8" useresolver="yes" profilemode="0" profiledepth="" profilelength="" urlprofilexml=""
