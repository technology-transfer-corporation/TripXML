...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	<!-- ================================================================== -->
	<!-- Amadeus_AirSeatMapRS.xsl 														-->
	<!-- ================================================================== -->
	<!-- Date: 20 Aug 2008 - Rastko														-->
	<!-- ================================================================== -->
	<xsl:output method="xml" omit-xml-declaration="yes" />
	<xsl:template match="/">
		<OTA_AirSeatMapRS Version="1.000">
			<xsl:choose>
				<xsl:when test="PoweredAir_RetrieveSeatMapReply/errorDetails/errorInformation/processingLevel != ''">
					<xsl:apply-templates select="PoweredAir_RetrieveSeatMapReply/errorDetails" />
				</xsl:when>
				...
				<xsl:otherwise>
					<Success />
					<SeatMapResponses>
						<xsl:apply-templates select="PoweredAir_RetrieveSeatMapReply" />
					</SeatMapResponses>
				</xsl:otherwise>
			</xsl:choose>
		</OTA_AirSeatMapRS>
	...
	<!--***********************************************************************************************************-->
	<xsl:template match="PoweredAir_RetrieveSeatMapReply">
		<SeatMapResponse>
