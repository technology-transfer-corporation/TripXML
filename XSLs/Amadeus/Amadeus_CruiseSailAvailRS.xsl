...
<!-- ================================================================== -->
<!-- Amadeus_CruiseSailAvailRS.xsl 	     											       -->
<!-- ================================================================== -->
<!-- Date: 30 Oct 2007 - Rastko											        		       -->
<!-- ================================================================== -->
<xsl:output method="xml" indent="yes" omit-xml-declaration="yes"/>
<xsl:variable name="mottable" select="document('..\..\tables\decoding\ttCruiseMot.xml')"/>
<xsl:template match="/">
	<xsl:apply-templates select="CruiseByPass_SailingAvailabilityReply" />
...
<xsl:template match="CruiseByPass_SailingAvailabilityReply">
