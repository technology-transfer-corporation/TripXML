...
<!-- ================================================================== -->
<!-- Amadeus_CruisePriceBookingRQ.xsl 	     									       -->
<!-- ================================================================== -->
...
<xsl:template match="GuestDetail[ContactInfo/@EmergencyFlag='false']" mode="contact">
	<travellerGroup>
		...
		<modeOfTransportation>
			...
			<motStatus>
				<xsl:choose>
					<xsl:when test="ContactInfo/GuestTransportation/@TransportationStatus = 'Available'">AVL</xsl:when>
					<xsl:when test="ContactInfo/GuestTransportation/@TransportationStatus = 'Unavailable'">CLO</xsl:when>
					<xsl:when test="ContactInfo/GuestTransportation/@TransportationStatus = 'OnRequest'">ONR</xsl:when>
					<xsl:when test="ContactInfo/GuestTransportation/@TransportationStatus !=''"><xsl:value-of select="ContactInfo/GuestTransportation/@TransportationStatus"/></xsl:when>
					<xsl:otherwise>AVL</xsl:otherwise>
				</xsl:choose>	
			</motStatus>
		</modeOfTransportation>
