...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	<!-- ================================================================== -->
	<!-- Amadeus_UpdateTSTRQ.xsl													  -->
	<!-- ================================================================== -->
	<!-- Date: 12 Oct 2010	- Rastko - changed code when fare basis is more than 6 and 9 chars long  -->
	<!-- Date: 27 Jan 2009	- Rastko														  -->
	<!-- ================================================================== -->
	...
	<xsl:template match="/">
		<PoweredTicket_UpdateTST>
			<xsl:apply-templates select="OTA_StoredFareUpdateRQ"/>
		</PoweredTicket_UpdateTST>
	</xsl:template>
	
	<xsl:template match="OTA_StoredFareUpdateRQ">
		...
		<fareReference>
			...
			<iDDescription>
				<iDSequenceNumber>
					<xsl:value-of select="PoweredTicket_DisplayTSTReply/fareList[fareReference/uniqueReference=$tst]/fareReference/iDDescription/iDSequenceNumber"/>
				</iDSequenceNumber>
			</iDDescription>
		</fareReference>
		...
		<xsl:if test="Segments">
			...
			<originDestination>
				<cityCode>
					<xsl:value-of select="PoweredPNR_PNRReply/originDestinationDetails/itineraryInfo[position()=$depRPH]/travelProduct/boardpointDetail/cityCode"/>
				</cityCode>
				<cityCode>
					<xsl:value-of select="PoweredPNR_PNRReply/originDestinationDetails/itineraryInfo[position()=$arrRPH]/travelProduct/offpointDetail/cityCode"/>
				</cityCode>
			</originDestination>
		</xsl:if>
