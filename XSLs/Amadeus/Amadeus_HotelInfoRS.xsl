...
<!-- ================================================================== -->
<!-- Amadeus_HotelInfoRS.xsl 															-->
<!-- ================================================================== -->
<!-- Date: 11 Apr 2006 - Rastko														-->
<!-- ================================================================== -->
	<xsl:output method="xml" omit-xml-declaration="yes" />
	<xsl:template match="/">
		<OTA_HotelDescriptiveInfoRS>
			<xsl:if test="MessagesOnly_Reply/CAPI_Messages">
				<xsl:apply-templates select="MessagesOnly_Reply/CAPI_Messages" />
			</xsl:if>
			<xsl:apply-templates select="PoweredHotel_FeaturesReply" />
		</OTA_HotelDescriptiveInfoRS>
	</xsl:template>
	<!-- *********************************************************************************************************  -->
	<xsl:template match="PoweredHotel_FeaturesReply">
		...
		<HotelDescriptiveContents>
			<HotelDescriptiveContent LanguageCode="en-us">
				...
				<!--HotelInfo>
					<xsl:if test="hotelFeaturesTerms/featuresTerms/category !=''">
						<Services>
							<Service>
								<Features>
									<xsl:apply-templates select="hotelFeaturesTerms/featuresTerms" mode="CodeDetail" />
								</Features>
							</Service>
						</Services>
					</xsl:if>
		...
		<Services>
			...
			<xsl:if test="preceding-sibling::hotelFeaturesTerms[featuresTerms/category = '2A']">
				<Service>
					...
					<Description>
						<Text><xsl:value-of select="preceding-sibling::hotelFeaturesTerms[featuresTerms/category = '2A']/featuresTerms/description"/></Text>
					</Description>
				</Service>
			</xsl:if>
			<xsl:if test="preceding-sibling::hotelFeaturesTerms[featuresTerms/category = '2B']">
				<Service>
					...
					<Description>
						<Text><xsl:value-of select="preceding-sibling::hotelFeaturesTerms[featuresTerms/category = '2B']/featuresTerms/description"/></Text>
					</Description>
				</Service>
			</xsl:if>
			<xsl:if test="preceding-sibling::hotelFeaturesTerms[featuresTerms/category = '2C']">
				<Service>
					...
					<Description>
						<Text><xsl:value-of select="preceding-sibling::hotelFeaturesTerms[featuresTerms/category = '2C']/featuresTerms/description"/></Text>
					</Description>
				</Service>
			</xsl:if>
			<xsl:if test="preceding-sibling::hotelFeaturesTerms[featuresTerms/category = '2D']">
				<Service>
					...
					<Description>
						<Text><xsl:value-of select="preceding-sibling::hotelFeaturesTerms[featuresTerms/category = '2D']/featuresTerms/description"/></Text>
					</Description>
				</Service>
			</xsl:if>
		</Services>
	...
	<xsl:template match="hotelFeaturesTerms" mode="address">
		<ContactInfos>
			<ContactInfo>
				<Addresses>
					<Address>
						<AddressLine><xsl:value-of select="featuresTerms/description"/></AddressLine>
						<xsl:if test="following-sibling::hotelFeaturesTerms[featuresTerms/category = '1B']">
							<AddressLine><xsl:value-of select="following-sibling::hotelFeaturesTerms[featuresTerms/category = '1B']/featuresTerms/description"/></AddressLine>
						</xsl:if>
						<CityName><xsl:value-of select="following-sibling::hotelFeaturesTerms[featuresTerms/category = '1C']/featuresTerms/description"/></CityName>
						<PostalCode><xsl:value-of select="following-sibling::hotelFeaturesTerms[featuresTerms/category = '1F']/featuresTerms/description"/></PostalCode>
						<xsl:if test="following-sibling::hotelFeaturesTerms[featuresTerms/category = '1D']">
							<StateProv>
								<xsl:attribute name="StateCode">	<xsl:value-of select="following-sibling::hotelFeaturesTerms[featuresTerms/category = '1D']/featuresTerms/description" /></xsl:attribute>
							</StateProv>
						</xsl:if>
						<CountryName><xsl:value-of select="following-sibling::hotelFeaturesTerms[featuresTerms/category = '1E']/featuresTerms/description"/></CountryName>
					</Address>
				</Addresses>
