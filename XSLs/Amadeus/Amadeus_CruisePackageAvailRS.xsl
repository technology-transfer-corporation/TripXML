...
<!-- ================================================================== -->
<!-- Amadeus_CruisePackageAvailRS.xsl 	     									       -->
<!-- ================================================================== -->
...
<xsl:template match="/">
	<xsl:apply-templates select="CruiseByPass_PackageAvailabilityReply" />
...
<xsl:template match="CruiseByPass_PackageAvailabilityReply">
