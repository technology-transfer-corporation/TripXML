...
<!-- ================================================================== -->
<!-- Amadeus_CarRulesRS.xsl															  -->
<!-- ================================================================== -->
<!-- Date: 21 Apr 2009 - Rastko														  -->
<!-- ================================================================== -->
<xsl:output omit-xml-declaration="yes"/>

<xsl:template match="/">
	<xsl:apply-templates select="PoweredCar_RateInformationFromAvailabilityReply"/>
...
<xsl:template match="PoweredCar_RateInformationFromAvailabilityReply">
	<OTA_VehRateRuleRS>
		<xsl:choose>
...
<xsl:template match="rateDetails">
	...
	<xsl:if test="taxCovSurchargeGroup[taxSurchargeCoverageInfo/chargeDetails/type='108' and taxSurchargeCoverageInfo/chargeDetails/amount !='']">
		<Fees>
			<xsl:for-each select="taxCovSurchargeGroup[taxSurchargeCoverageInfo/chargeDetails/type='108' and taxSurchargeCoverageInfo/chargeDetails/amount !='']">
				<Fee>
					...
					<xsl:attribute name="IncludedInRate">true</xsl:attribute>
	...
	<RentalRate>
		<VehicleCharges>
			<VehicleCharge>
				...
				<xsl:attribute name="Purpose">Base rate</xsl:attribute>
				<xsl:choose>
		...
		<RentalRate>
			...
			<VehicleCharges>
				<VehicleCharge>
					...
					<xsl:attribute name="Purpose">Extra day</xsl:attribute>
				</VehicleCharge>			
			</VehicleCharges>
		</RentalRate>
	</xsl:if>
		...
		<RentalRate>
			...
			<VehicleCharges>
				<VehicleCharge>
					...
					<xsl:attribute name="Purpose">Extra hour</xsl:attribute>
				</VehicleCharge>			
			</VehicleCharges>
		</RentalRate>
	</xsl:if>
	<xsl:if test="chargeDetails[type='045' and amount!='']">
		<RentalRate>
			<VehicleCharges>
				<VehicleCharge>
					<xsl:attribute name="Amount">
						<xsl:value-of select="translate(chargeDetails[type='045']/amount,'.','')"/>
					</xsl:attribute>
					...
					<xsl:attribute name="DecimalPlaces">
						<xsl:choose>
							<xsl:when test="contains(chargeDetails[type='045']/amount,'.')">2</xsl:when>
							<xsl:otherwise>0</xsl:otherwise>
						</xsl:choose>
					</xsl:attribute>
					<xsl:attribute name="Purpose">State tax</xsl:attribute>
				</VehicleCharge>
			</VehicleCharges>
		</RentalRate>			
	</xsl:if>
...
<xsl:template match="rateDetail" mode="total">
	<TotalCharge>
		...
		<xsl:attribute name="Purpose">Total price</xsl:attribute>
	</TotalCharge>
</xsl:template>
