...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt" xmlns:ttVB="urn:ttVB" exclude-result-prefixes="msxsl ttVB" version="1.0">
  <!-- ================================================================== -->
  <!-- Amadeus_LowFareScheduleRQ.xsl 												-->
  <!-- ================================================================== -->
  <!-- Date: 02 May 2013 - Suraj - Added the Cabin type "Economy"			-->
  <!-- Date: 26 Nov 2012 - Rastko - removed near date business logic				-->
  <!-- Date: 24 Jul 2009 - Rastko															-->
  <!-- ================================================================== -->
  ...
  <xsl:template match="OTA_AirLowFareSearchScheduleRQ">
    <PoweredLowestFare_Search>
      ...
      <xsl:if test="TravelPreferences/CabinPref/@Cabin = 'First' or TravelPreferences/CabinPref/@Cabin = 'Business' or TravelPreferences/CabinPref/@Cabin = 'Economy' or TravelPreferences/VendorPref/@Code!='' or 	TravelPreferences/FlightTypePref/@FlightType != ''">
        <travelFlightInfo>
          <xsl:if test="TravelPreferences/CabinPref/@Cabin = 'First' or TravelPreferences/CabinPref/@Cabin = 'Business'  or TravelPreferences/CabinPref/@Cabin = 'Economy'  or  TravelPreferences/VendorPref/@Code!=''">
            <xsl:if test="TravelPreferences/CabinPref/@Cabin = 'First' or TravelPreferences/CabinPref/@Cabin = 'Economy'  or TravelPreferences/CabinPref/@Cabin = 'Business'">
              <cabinId>
