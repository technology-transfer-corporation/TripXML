...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt" version="1.0">
	<!-- ================================================================== -->
	<!-- v03_Amadeus_TravelBuildRQ.xsl 													       -->
	<!-- ================================================================== -->
	<!-- Date: 24 Feb 2014 - Rastko - mapped adult birth date							      -->
	...
	<!-- Date: 08 Jul 2013 - Rastko - added SecondaryCode for corporate fares pricing		       -->
	<!-- Date: 26 Nov 2012 - Laleen  - corrected passenger prefix mapping				      -->
	<!-- Date: 07 Aug 2012 - Shashin  - corrected cryptic FXP entry selection			      -->
	<!-- Date: 22 May 2012 - Shashin  - send SK elements								      -->
	<!-- Date: 28 Mar 2012 - Shashin - TicketAdvisory change to check 'OK'			      -->
	<!-- Date: 28 Mar 2011 - Rastko limit OISI new process to airline B6				       -->
