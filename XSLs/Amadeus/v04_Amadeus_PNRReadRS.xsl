...
<!-- ================================================================== -->
<!-- v04_Amadeus_PNRReadRS.xsl 													       -->
<!-- ================================================================== -->
<!-- Date: 21 Feb 2014 - Rastko - upgraded to same level as Amadeus WS file		       -->
			...
			<xsl:when test="pnrHeader/reservationInfo/reservation/controlNumber!=''">
				...
				<TravelItinerary>	
					...
					<ItineraryInfo>							
						<xsl:if test="originDestinationDetails/itineraryInfo[elementManagementItinerary/segmentName='AIR'] | originDestinationDetails/itineraryInfo[elementManagementItinerary/segmentName='CCR'] | originDestinationDetails/itineraryInfo[elementManagementItinerary/segmentName='CU'] | originDestinationDetails/itineraryInfo[elementManagementItinerary/segmentName='HHL'] | originDestinationDetails/itineraryInfo[elementManagementItinerary/segmentName='HU'] | originDestinationDetails/itineraryInfo[elementManagementItinerary/segmentName='RU'] | originDestinationDetails/itineraryInfo[elementManagementItinerary/segmentName='AU'] | originDestinationDetails/itineraryInfo[elementManagementItinerary/segmentName='SUR'] | originDestinationDetails/itineraryInfo[elementManagementItinerary/segmentName='TRN'] | originDestinationDetails/itineraryInfo[elementManagementItinerary/segmentName='CRU'] | originDestinationDetails/itineraryInfo[elementManagementItinerary/segmentName='TU']" >
							<ReservationItems>								
								...
								<xsl:if test="PoweredTicket_DisplayTSTReply[not(applicationError)]">
									<xsl:apply-templates select="PoweredTicket_DisplayTSTReply/fareList" mode="v04"/>
								</xsl:if>
							</ReservationItems>
						</xsl:if>	
						<xsl:if test="originDestinationDetails/itineraryInfo[elementManagementItinerary/segmentName='RU']">
								<ReservationItems>
									<xsl:apply-templates select="originDestinationDetails/itineraryInfo" mode="Other"/>
									<xsl:if test="PoweredTicket_DisplayTSTReply[not(applicationError)]">
										<ItemPricing>
						...
						<xsl:apply-templates select="dataElementsMaster/dataElementsIndiv[elementManagementData/segmentName='SK'][1]" mode="SK"/>
						<SpecialRequestDetails>
							...
							<xsl:if test="dataElementsMaster/dataElementsIndiv[contains(elementManagementData/segmentName,'RI')] or dataElementsMaster/dataElementsIndiv[contains(elementManagementData/segmentName,'RC')] or dataElementsMaster/dataElementsIndiv[elementManagementData/segmentName='FE']">
								<SpecialRemarks>
	...
	<ItemPricing>
		<xsl:attribute name="ItemRPH_List">
			<xsl:for-each select="segmentInformation">
				<xsl:variable name="segref"><xsl:value-of select="segmentReference/refDetails/refNumber"/></xsl:variable>
		...
		<xsl:attribute name="AssociatedItemRPH">
			<xsl:for-each select="paxSegReference/refDetails">
				<xsl:variable name="paxref"><xsl:value-of select="refNumber"/></xsl:variable>
				<xsl:if test="position() > 1">
					<xsl:text> </xsl:text>
				</xsl:if>
		...
		<xsl:if test="contains(../../Cryptic_GetScreen_Reply[position()=$pos]/CAPI_Screen/Response,'T-') or pricingInformation/fcmi!=''">
			<TPA_Extensions>
				<xsl:attribute name="ManualPricing">
					<xsl:choose>
						<xsl:when test="pricingInformation/fcmi='1' or pricingInformation/fcmi='4' or pricingInformation/fcmi='Q'">
		...
		<AirFareInfo>
			...
			<xsl:attribute name="RepriceRequired">
				<xsl:choose>
					<xsl:when test="pricingInformation/fcmi = '0'"><xsl:value-of select="'false'"/></xsl:when>
			...
			<ItinTotalFare>
				...
				<xsl:if test="fareDataInformation/fareDataSupInformation[fareDataQualifier = 'E'] and $userid!='morqua'">
					<xsl:variable name="ef">
						<xsl:apply-templates select="fareDataInformation" mode="totalequiv">
							<xsl:with-param name="sum">0</xsl:with-param>
							<xsl:with-param name="loop">
								<xsl:value-of select="$loop"/>
							</xsl:with-param>
					...
					<EquivFare>
						<xsl:attribute name="Amount"><xsl:choose><xsl:when test="$ef != ''"><xsl:value-of select="$ef"/></xsl:when><xsl:otherwise>0</xsl:otherwise></xsl:choose></xsl:attribute>
						<xsl:attribute name="CurrencyCode">
							<xsl:value-of select="fareDataInformation/fareDataSupInformation[fareDataQualifier = 'B']/fareCurrency"/>
						</xsl:attribute>
						<xsl:attribute name="DecimalPlaces">
				...
				<xsl:if test="fareDataInformation/fareDataSupInformation[fareDataQualifier = 'TOF']">
					<Fees>
						<Fee>
							<xsl:attribute name="Amount"><xsl:choose><xsl:when test="$Feef!= ''"><xsl:value-of select="$Feef"/></xsl:when><xsl:otherwise>0</xsl:otherwise></xsl:choose></xsl:attribute>
...
<xsl:template match="fareList" mode="ptc">
	<PTC_FareBreakdown>
		...
		<PassengerFare>
			...
			<xsl:if test="fareDataInformation/fareDataSupInformation[fareDataQualifier = 'E'] and $userid!='morqua'">
				...
				<EquivFare>
					<xsl:attribute name="Amount"><xsl:choose><xsl:when test="$efpax != 'NaN'"><xsl:value-of select="$efpax"/></xsl:when><xsl:otherwise>0</xsl:otherwise></xsl:choose></xsl:attribute>
					<xsl:attribute name="CurrencyCode">
						<xsl:value-of select="fareDataInformation/fareDataSupInformation[fareDataQualifier = 'B']/fareCurrency"/>
					</xsl:attribute>
					<xsl:attribute name="DecimalPlaces">
			...
			<Taxes>
				<xsl:apply-templates select="taxInformation">
					...
					<xsl:with-param name="dec"><xsl:value-of select="$dec"/></xsl:with-param>
				</xsl:apply-templates>
			</Taxes>
			<xsl:if test="fareDataInformation/fareDataSupInformation[fareDataQualifier = 'TOF']">
				<Fees>
					<Fee>
						<xsl:attribute name="Amount"><xsl:choose><xsl:when test="$feefpax!= 'NaN'"><xsl:value-of select="$feefpax"/></xsl:when><xsl:otherwise>0</xsl:otherwise></xsl:choose></xsl:attribute>
					...
					<BagAllowance>
						<xsl:choose>
							<xsl:when test="bagAllowanceInformation/bagAllowanceDetails/baggageQuantity!=''">
								<xsl:attribute name="Quantity"><xsl:value-of select="bagAllowanceInformation/bagAllowanceDetails/baggageQuantity"/></xsl:attribute>
								<xsl:attribute name="Type"><xsl:text>Piece</xsl:text></xsl:attribute>
							</xsl:when>
							<xsl:otherwise>
								<xsl:attribute name="Weight"><xsl:value-of select="bagAllowanceInformation/bagAllowanceDetails/baggageWeight"/></xsl:attribute>
								<xsl:attribute name="Type"><xsl:text>Weight</xsl:text></xsl:attribute>
								<xsl:attribute name="Unit"><xsl:value-of select="bagAllowanceInformation/bagAllowanceDetails/measureUnit"/></xsl:attribute>
							</xsl:otherwise>
						</xsl:choose>
	...
	<xsl:template match="passengerData">
	   <CustomerInfo>
		   ...
		   <Customer>
			   	...
			   	<PersonName>
				   	<xsl:attribute name="NameType">
				   		<xsl:choose>
							...
							<xsl:otherwise><xsl:value-of select="travellerInformation/passenger/type"/></xsl:otherwise>
						</xsl:choose>
				   	</xsl:attribute>
				  	 <GivenName>
			   	...
			   	<xsl:variable name="paxref"><xsl:value-of select="../elementManagementPassenger/reference/number"/></xsl:variable>
				...
				<xsl:apply-templates select="../../dataElementsMaster/dataElementsIndiv[serviceRequest/ssr/type='FQTV'][serviceRequest/ssr/status='HK']" mode="Fqtv">
					<xsl:with-param name="paxref"><xsl:value-of select="$paxref"/></xsl:with-param>
				</xsl:apply-templates>
		   </Customer>
		</CustomerInfo>
		...
		<xsl:choose>
			...
			<xsl:otherwise>
				<Air>			
					...
					<TPA_Extensions>
						<xsl:attribute name="ConfirmationNumber"><xsl:value-of select="itineraryReservationInfo/reservation/controlNumber"/></xsl:attribute>
					</TPA_Extensions>
				</Air>	
			</xsl:otherwise>	
		</xsl:choose>
...
<xsl:template match="typicalCarData">
	...
	<!-- SK Element	   	                                    -->
	<!-- ************************************************************** -->
	<xsl:template match="dataElementsIndiv" mode="SK">
		<KeywordElement>		
			<Keyword>
				<xsl:value-of select="serviceRequest/ssr/type"></xsl:value-of>
			</Keyword>
			<AirlineCode>
				<xsl:value-of select="serviceRequest/ssr/companyId"></xsl:value-of>
			</AirlineCode>
			<Status>
				<xsl:value-of select="serviceRequest/ssr/status"></xsl:value-of>
			</Status>
			<FreeText>
				<xsl:value-of select="serviceRequest/ssr/freeText"></xsl:value-of>
			</FreeText>
			<NumberInParty>
			<xsl:value-of select="serviceRequest/ssr/quantity"></xsl:value-of>
			</NumberInParty>			
		</KeywordElement>
	</xsl:template>
		...
		<FormOfPayment>
			<xsl:choose>
				<xsl:when test="substring(otherDataFreetext/longFreetext,1,2) ='CC' or substring(otherDataFreetext/longFreetext,1,6) = 'PAX CC'">
					...
					<xsl:variable name="card"><xsl:value-of select="substring-after(substring-after(otherDataFreetext/longFreetext,'/'),'/')"/></xsl:variable>
					<xsl:variable name="conf">
						<xsl:if test="$card != ''">
							<xsl:choose>
								<xsl:when test="contains($card,'/')"><xsl:value-of select="substring-after($card,'/')"/></xsl:when>
					...
					<xsl:variable name="amt">
						<xsl:if test="$card != ''">
							<xsl:choose>
								<xsl:when test="contains($card,'/')"><xsl:value-of select="substring-before($card,'/')"/></xsl:when>
								<xsl:when test="substring($card,1,1)='N' and not(contains($card,'.'))"></xsl:when>
								<xsl:when test="substring($card,1,1)='A' and not(contains($card,'.'))"></xsl:when>
								<xsl:when test="not(contains($card,'.'))"></xsl:when>
		...
		<FormOfPayment>
			...
			<MiscChargeOrder>
				<xsl:attribute name="TravelerRefNumber">
					<xsl:variable name="pax"><xsl:value-of select="referenceForDataElement/reference/number"/></xsl:variable>
			...
			<xsl:if test="mcoRecord/groupOfFareElements">
				<TPA_Extensions>
							...
							<AgencyCommission>
								<xsl:choose>
									<xsl:when test="contains(fareElementData/freeText,'*M*') or contains(fareElementData/freeText,'*C*') or contains(fareElementData/freeText,'*G*') or contains(fareElementData/freeText,'*F*')">
										...
										<xsl:variable name="comm">
											<xsl:choose>
												...
												<xsl:otherwise><xsl:value-of select="$comm1"/></xsl:otherwise>
											</xsl:choose>
										</xsl:variable>
										<xsl:choose>
									...
									<xsl:when test="contains(fareElementData/freeText,'*AM*')">
										<xsl:attribute name="Amount">
											<xsl:value-of select="translate(substring-after(fareElementData/freeText,'*AM*'),'A','')"/>
										</xsl:attribute>
									</xsl:when>
					...
					<xsl:if test="mcoRecord/groupOfFareElements/fareElementData/freeTextDetails/informationType='FA' or mcoRecord/groupOfFareElements/fareElementData/freeTextDetails/informationType='FB' or mcoRecord/groupOfFareElements/fareElementData/freeTextDetails/informationType='FI'">
						<IssuedTickets>
							<xsl:for-each select="mcoRecord/groupOfFareElements[fareElementData/freeTextDetails/informationType='FA' or fareElementData/freeTextDetails/informationType='FB']">
								<IssuedTicket><xsl:value-of select="fareElementData/freeText"/></IssuedTicket>
							</xsl:for-each>
							<xsl:for-each select="mcoRecord/groupOfFareElements[fareElementData/freeTextDetails/informationType='FI']">
								<IssuedInvoice><xsl:value-of select="fareElementData/freeText"/></IssuedInvoice>
							</xsl:for-each>
						</IssuedTickets>
					</xsl:if>
					<xsl:if test="mcoRecord/groupOfFareElements/fareElementData/freeTextDetails/informationType='FP'">
						<xsl:for-each select="mcoRecord/groupOfFareElements[fareElementData/freeTextDetails/informationType='FP' and contains(fareElementData/freeText,'CC')]">
							<PaymentCard>
								<xsl:attribute name="CardCode">
									<xsl:choose>
										...
										<xsl:otherwise><xsl:value-of select="substring(substring-after(fareElementData/freeText,'CC'),1,2)"/></xsl:otherwise>
									</xsl:choose>					
								</xsl:attribute>
								<xsl:attribute name="CardNumber">
									<xsl:variable name="cardnum">
										<xsl:value-of select="translate(substring(substring-after(fareElementData/freeText,'CC'),3,16),'/T','')"/>
									</xsl:variable>
									<xsl:value-of select="$cardnum"/>
								</xsl:attribute>
								<xsl:attribute name="ExpireDate">
									<xsl:value-of select="substring(substring-after(fareElementData/freeText,'/'),1,2)"/>
									<xsl:value-of select="substring(substring-after(fareElementData/freeText,'/'),3,2)"/>
								</xsl:attribute>		
								<xsl:if test="contains(substring-after(fareElementData/freeText,'/'),'/')">
									<xsl:attribute name="ConfirmationNumber">
										<xsl:value-of select="substring-after(substring-after(fareElementData/freeText,'/'),'/')"/>
									</xsl:attribute>
								</xsl:if>
							</PaymentCard>
						</xsl:for-each>
						...
						<xsl:variable name="na">
							<xsl:choose>
								<xsl:when test="contains(otherDataFreetext/longFreetext,'NA-')">
									...
									<xsl:value-of select="substring-after(otherDataFreetext/longFreetext,'NA-')"/>																</xsl:when>
								<xsl:otherwise>
									<xsl:value-of select="otherDataFreetext/longFreetext"/>
								</xsl:otherwise>
							</xsl:choose>
		...
		<xsl:if test="address[option='ST']">
			<StateProv>
				<xsl:choose>
					...
					<xsl:otherwise><xsl:value-of select="address[option='ST']/optionText"/></xsl:otherwise>
				</xsl:choose>
			</StateProv>
		</xsl:if>
		<xsl:if test="address[option='CO']">
			<CountryName>
				<xsl:choose>
					...
					<xsl:otherwise><xsl:value-of select="address[option='CO']/optionText"/></xsl:otherwise>
				</xsl:choose>
			</CountryName>
		</xsl:if>
	...
	<xsl:template match="dataElementsIndiv" mode="OSI">
		<OtherServiceInformation>		
			<xsl:if test="otherDataFreetext/freetextDetail/type='28'">
				...
				<Text>
					<xsl:choose>
						<xsl:when test="contains(otherDataFreetext/longFreetext,'//')">
							<xsl:value-of select="concat(substring-before(otherDataFreetext/longFreetext,'//'),'@',substring-after(otherDataFreetext/longFreetext,'//'))"/>
						</xsl:when>
						<xsl:otherwise>
							<xsl:value-of select="otherDataFreetext/longFreetext"/>
						</xsl:otherwise>
