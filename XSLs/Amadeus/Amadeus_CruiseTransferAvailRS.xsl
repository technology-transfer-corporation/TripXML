...
<!-- ================================================================== -->
<!-- Amadeus_CruiseTransferAvailRS.xsl 	     										       -->
<!-- ================================================================== -->
...
<xsl:template match="/">
	<xsl:apply-templates select="CruiseByPass_TransferAvailabilityReply" />
...
<xsl:template match="CruiseByPass_TransferAvailabilityReply">
