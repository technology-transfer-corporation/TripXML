...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	<!-- ================================================================== -->
	<!-- Amadeus_AirPriceRS.xsl 															-->
	<!-- ================================================================== -->
	<!-- Date: 28 Jan 2012 -  Rastko added mapping to Errors collected in business logic		-->
	<!-- Date: 21 Apr 2011 -  Rastko added mapping to PoweredTicket_DisplayTSTReply		-->
	...
	<xsl:template match="/">
		<xsl:apply-templates select="PoweredPNR_Reply" />
		<xsl:apply-templates select="PoweredFare_PricePNRWithLowerFaresReply" />
		<xsl:apply-templates select="PoweredFare_PricePNRWithBookingClassReply" />
	...
	<xsl:template match="PoweredPNR_Reply">
		<OTA_AirPriceRS>
			<xsl:attribute name="Version">2003.2</xsl:attribute>
			<Errors>
	...
	<xsl:template match="PoweredFare_PricePNRWithLowerFaresReply | PoweredFare_PricePNRWithBookingClassReply | PoweredTicket_DisplayTSTReply">
		<OTA_AirPriceRS>
			<xsl:attribute name="Version">2003.2</xsl:attribute>
			<xsl:choose>
								...
								<PTC_FareBreakdowns>
									<xsl:for-each select="AirTravelerAvail/PassengerTypeQuantity">
										...
										<xsl:variable name="paxnum">
											<xsl:value-of select="../../PoweredPNR_PNRReply/travellerInfo[passengerData/travellerInformation/passenger/type=$paxtype]/elementManagementPassenger/reference/number"/>
										</xsl:variable>
