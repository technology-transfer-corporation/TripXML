...
<!-- ================================================================== -->
<!-- v03_Amadeus_PNRReadRS.xsl 													       -->
<!-- ================================================================== -->
<!-- Date: 24 Feb 2014 - Rastko - corrected mapping of adult birth date			      -->
<!-- Date: 22 May 2012 - Shashin  - display SK elements							      -->
<!-- Date: 08 Feb 2012 - Rastko  - display misc segment even when no travel segments in PNR -->
<!-- Date: 25 Mar 2011 - Rastko replace // by @ in ISO								       -->
...
<xsl:template match="fareList">
	<PTC_FareBreakdown>
		...
		<PassengerTypeQuantity>
			<xsl:attribute name="Code">
				<xsl:variable name="paxref"><xsl:value-of select="paxSegReference/refDetails[1]/refNumber"/></xsl:variable>
		...
		<xsl:if test="otherPricingInfo/attributeDetails[attributeType='FCA'] or otherPricingInfo/attributeDetails[attributeType='PAY']">
			<TPA_Extensions>
				...
				<xsl:if test="validatingCarrier/carrierInformation/carrierCode != ''">
...
<xsl:template match="taxInformation">
	...
	<xsl:template match="passengerData">
	   <CustomerInfo>
		   ...
		   <Customer>
		   		<xsl:if test="dateOfBirth/dateAndTimeDetails[qualifier='706'] and count(travellerInformation/passenger) = 1">
				...
				<Air>			
					...
					<xsl:attribute name="FlightNumber">				
						<xsl:choose>
							...
							<xsl:otherwise>
								<xsl:value-of select="travelProduct/productDetails/identification"/>														</xsl:otherwise>
						</xsl:choose>
					</xsl:attribute>
