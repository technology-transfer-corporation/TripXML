...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt" xmlns:ttVB="urn:ttVB" exclude-result-prefixes="msxsl ttVB" version="1.0">
	<!-- ================================================================== -->
	<!-- Amadeus_AirAvailRS.xsl 															-->
	<!-- ================================================================== -->
	<!-- Date: 01 Apr 2006 - Rastko														-->
	<!-- ================================================================== -->
<xsl:output method="xml" omit-xml-declaration="yes"/>

	<xsl:template match="/">
		<xsl:apply-templates select="PoweredAir_MultiAvailabilityReply" />
		<xsl:apply-templates select="MessagesOnly_Reply" />
	</xsl:template>
	
	<xsl:template match="MessagesOnly_Reply">
		<OTA_AirAvailRS Version="1.001">
	...
	<xsl:template match="PoweredAir_MultiAvailabilityReply">
		<OTA_AirAvailRS>
			...
			<xsl:for-each select="singleCityPairInfo[flightInfo]">
				<OriginDestinationOptions>
					<xsl:for-each select="flightInfo[basicFlightInfo/productTypeDetail/productIndicators='S' or basicFlightInfo/productTypeDetail/productIndicators='D']">
						<!--xsl:if test="(basicFlightInfo/productTypeDetail/productIndicators='S') or (basicFlightInfo/productTypeDetail/productIndicators='D')"-->
