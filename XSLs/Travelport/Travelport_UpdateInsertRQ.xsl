<?xml version="1.0" ?>
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:univ="http://www.travelport.com/schema/universal_v27_0" xmlns:com="http://www.travelport.com/schema/common_v27_0" version="1.0">
	<!-- ================================================================== -->
	<!-- Travelport_UpdateInsertRQ.xsl 																							-->
	<!-- ================================================================== -->
	<!-- Date: 25 Sep 2014 - Rastko - new file																				-->
	<!-- ================================================================== -->
	<xsl:output method="xml" omit-xml-declaration="yes" />
	<xsl:variable name="GDS"><xsl:value-of select="UpdateInsert/OTA_UpdateRQ/POS/TPA_Extensions/Provider/Name"/></xsl:variable>
	<xsl:template match="/">
		<univ:UniversalRecordModifyReq ReturnRecord="true">
			<xsl:attribute name="Version">
				<xsl:value-of select="UpdateInsert/OTA_UpdateRQ/@SequenceNmbr"/>
				<xsl:value-of select="UpdateInsert/OTA_UpdateSessionedRQ/@SequenceNmbr"/>
			</xsl:attribute>
			...
			<univ:RecordIdentifier>
				<xsl:attribute name="ProviderCode">
					<xsl:choose>
						<xsl:when test="UpdateInsert/OTA_UpdateRQ/@Target='WSP' or UpdateInsert/OTA_UpdateSessionedRQ/@Target='WSP'">
				...
				<xsl:attribute name="ProviderLocatorCode">
					<xsl:value-of select="UpdateInsert/OTA_UpdateRQ/UniqueID/CompanyName/@Code"/>
					<xsl:value-of select="UpdateInsert/OTA_UpdateSessionedRQ/UniqueID/CompanyName/@Code"/>
				</xsl:attribute> 
				<xsl:attribute name="UniversalLocatorCode">
					<xsl:value-of select="UpdateInsert/OTA_UpdateRQ/UniqueID/@ID"/>
					<xsl:value-of select="UpdateInsert/OTA_UpdateSessionedRQ/UniqueID/@ID"/>
				</xsl:attribute>
			</univ:RecordIdentifier>
	...
	<xsl:template match="SpecialRemark">
		<xsl:if test="@RemarkType='H'">
			<com:GeneralRemark Category="Z" TypeInGds="Historical">
				<com:RemarkData><xsl:value-of select="Text"/></com:RemarkData>
			</com:GeneralRemark>
		</xsl:if>
	</xsl:template>
	<!-- ********************************************************************************************-->
	...
	<xsl:template match="Remark">
		<com:GeneralRemark TypeInGds="Basic">
			<com:RemarkData><xsl:value-of select="."/></com:RemarkData>
		</com:GeneralRemark>
	</xsl:template>
	<!-- ********************************************************************************************-->
	...
	<xsl:template match="PriceData">
		<StorePriceMods>
			...
			<xsl:if test="../../POS/TPA_Extensions/Provider/Name = 'Galileo'">
				<PlatingAirVMod>
					<AirV><xsl:value-of 	select="../../OTA_AirBookRQ/AirItinerary/OriginDestinationOptions/OriginDestinationOption/FlightSegment/MarketingAirline/@Code"/> </AirV>
				</PlatingAirVMod>
			</xsl:if>
