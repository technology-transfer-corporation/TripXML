...
Namespace wsTravelTalk
    ...
    <System.Web.Services.Protocols.SoapDocumentService(RoutingStyle:=System.Web.Services.Protocols.SoapServiceRoutingStyle.RequestElement), _
        ...
        Name:="wsTravelBuild_v03", _
        Description:="A TripXML Web Service to Process Travel Build Request - version 03")> _
    Public Class wsTravelBuild_v03
...
#Region " Decode Function "
        ...
        Private Function DecodeTravelBuild(ByVal strResponse As String, ByVal UserID As String, ByRef strUUID As String) As String
            ...
            Try
                ...
                Select Case ttCredential.Providers(0).Name.ToLower
                    ...
                    Case "sabre"
                        ...
                        strResponse = SendTravelRequestSabre(ttServiceID, ttCredential, ttProviderSystems, strRequest, "v03")
                    ...
                    Case "worldspan"
                        strResponse = SendTravelRequestWorldspan(ttServiceID, ttCredential, ttProviderSystems, strRequest, "v03")
                    Case Else
                        Throw New Exception(sb.Append("Provider ").Append(ttCredential.Providers(0).Name).Append(" Not Currently Supported.").ToString())
                        sb.Remove(0, sb.Length())
                End Select

                strResponse = DecodeTravelBuild(strResponse, ttCredential.UserID, UUID)
...
#Region " Web Methods "
        ...
        Public Function wmTravelBuild(ByVal OTA_TravelItineraryRQ As wmTravelItineraryIn.OTA_TravelItineraryRQ) As <XmlElementAttribute("OTA_TravelItineraryRS")> wmTravelItineraryOut_v03.OTA_TravelItineraryRS
            Dim oSerializer As XmlSerializer = New XmlSerializer(GetType(wmTravelItineraryIn.OTA_TravelItineraryRQ))
            ...
            Dim oTravelBuildRS As wmTravelItineraryOut_v03.OTA_TravelItineraryRS
            ...
            Try
                ...
                oTravelBuildRS = CType(oSerializer.Deserialize(oReader), wmTravelItineraryOut_v03.OTA_TravelItineraryRS)
            Catch ex As Exception
