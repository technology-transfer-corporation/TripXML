...
namespace wsTripXML.wsTravelTalk
{
    ...
    [WebService(Namespace = "http://tripxml.downtowntravel.com/tripxml/wsLowFareFlights", Name = "wsLowFareFlights", Description = "A TripXML Web Service to Process Low Fare Flights Messages Request.")]
    public class wsLowFareFlights : WebService
    {
        ...
        private string DecodeLowFarePlus(string strResponse, string UserID)
        {
            try
            {
                ...
                // Dim ttHiddenAirlines As DataView = CType(Application.Get("ttHiddenAirlines"), DataView)
                // Dim ttEquipments As DataView = CType(Application.Get("ttEquipments"), DataView)
        ...
        private string ServiceRequest(string strRequest, ttServices ttServiceID)
        {
            ...
            var DoAmadeusWSSearches = new SearchAmadeusWSFlights[100];
            var DoGalileoSearches = new SearchGalileoFlights[100];
            var DoSabreSearches = new SearchSabreFlights[100];
            var DoWorldspanSearches = new SearchWorldspanFlights[100];
            ...
            try
            {
                            ...
                            case "amadeus":
                                {
                                    try
                                    {
                                        ...
                                        if (ttProviderSystems.AmadeusWS == true)
                                        {
                                            ...
                                            DoAmadeusWSSearches[i] = new SearchAmadeusWSFlights(withBlock.Providers[i].PCC, withBlock.UserID, withBlock.System, ref ttProviderSystems, ref oAmadeusWS);
                            ...
                            case "galileo":
                                {
                                    try
                                    {
                                        ...
                                        DoGalileoSearches[i] = new SearchGalileoFlights(withBlock.Providers[i].PCC, withBlock.UserID, withBlock.System, ref ttProviderSystems, ref oGalileo);
                            ...
                            case "Sabre":
                                {
                                    try
                                    {
                                        ...
                                        DoSabreSearches[i] = new SearchSabreFlights(withBlock.Providers[i].PCC, withBlock.UserID, withBlock.System, ref ttProviderSystems, ref oSabre);
                            ...
                            case "Worldspan":
                                {
                                    try
                                    {
                                        ...
                                        DoWorldspanSearches[i] = new SearchWorldspanFlights(withBlock.Providers[i].PCC, withBlock.UserID, withBlock.System, ref ttProviderSystems, ref oWorldspan);
                ...
                {
                    if ((int)Math.Round(DateTime.Now.Subtract(StartCounter).TotalSeconds) > 300)
                        break;
                    Thread.Sleep(10);
                }
        ...
        public wmLowFareFlightsOut.OTA_AirLowFareSearchFlightsRS wmLowFareFlights(wmLowFareFlightsIn.OTA_AirLowFareSearchFlightsRQ OTA_AirLowFareSearchFlightsRQ)
        {

            string xmlMessage = "";
            wmLowFareFlightsOut.OTA_AirLowFareSearchFlightsRS oLowFareFlightsRS = null;
            XmlSerializer oSerializer = null;
            System.IO.StringWriter oWriter = null;
            System.IO.StringReader oReader = null;

            oSerializer = new XmlSerializer(typeof(wmLowFareFlightsIn.OTA_AirLowFareSearchFlightsRQ));
            ...
            {
                oSerializer = null;
                oSerializer = new XmlSerializer(@type: typeof(wmLowFareFlightsOut.OTA_AirLowFareSearchFlightsRS));
                oReader = new System.IO.StringReader(xmlMessage);
                oLowFareFlightsRS = (wmLowFareFlightsOut.OTA_AirLowFareSearchFlightsRS)oSerializer.Deserialize(oReader);
            }
            catch (Exception ex)
            {
        ...
        [WebMethod(Description = "Process Low Fare Flights Xml Messages Request.")]
        public string wmLowFareFlightsXml(string xmlRequest)
        {
    ...
    public class SearchAmadeusWSFlights
    {
        ...
        public SearchAmadeusWSFlights(string _pcc, string _userid, string _System, ref TripXMLProviderSystems _ttProviderSystems, ref cServiceAmadeusWS _oAmadeusWS)
        {
    ...
    public class SearchGalileoFlights
    {
        ...
        public SearchGalileoFlights(string _pcc, string _userid, string _System, ref TripXMLProviderSystems _ttProviderSystems, ref cServiceGalileo _oGalileo)
        {
    ...
    public class SearchSabreFlights
    {
        ...
        public SearchSabreFlights(string _pcc, string _userid, string _System, ref TripXMLProviderSystems _ttProviderSystems, ref cServiceSabre _oSabre)
        {
            StartSearch_Wrapper = new StartSearch_Delegate(DoAmadeusSearchWS);
            pcc = _pcc;
            userid = _userid;
    ...
    public class SearchWorldspanFlights
    {
        ...
        public SearchWorldspanFlights(string _pcc, string _userid, string _System, ref TripXMLProviderSystems _ttProviderSystems, ref cServiceWorldspan _oWorldspan)
        {
            StartSearch_Wrapper = new StartSearch_Delegate(DoAmadeusSearchWS);
            pcc = _pcc;
            userid = _userid;
