...
namespace wsTripXML.wsTravelTalk
{
    ...
    [WebService(Namespace = "http://tripxml.downtowntravel.com/tripxml/wsCarInfo", Name = "wsCarInfo", Description = "A TripXML Web Service to Process Car Info Messages Request.")]
    public class wsCarInfo : WebService
    {
        private StringBuilder sb = new StringBuilder();

        #region  Web Services Designer Generated Code 

        public wsCarInfo() : base()
        {
