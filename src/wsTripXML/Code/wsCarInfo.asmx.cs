...
{
    public partial class wsCarInfo
    {
        private StringBuilder sb = new StringBuilder();

        private readonly modMain _modMain;

        public wsCarInfo(modMain modMain)
        {
            _modMain = modMain;
        }
        ...
        private string ServiceRequest(string strRequest, ttServices ttServiceID)
        {
            ...
            finally
            {
                ...
                if (modCore.Trace)
                    CoreLib.SendTrace(ttCredential.UserID, "wsCarInfo", "============= OTA Response ============= ", strResponse, ttProviderSystems.LogUUID);
            }
        ...
        #region  Web Methods 
        public wmCarInfoOut.OTA_VehLocDetailRS wmCarInfo(wmCarInfoIn.OTA_VehLocDetailRQ OTA_VehLocDetailRQ)
        {
            string xmlMessage = "";
            wmCarInfoOut.OTA_VehLocDetailRS oCarInfoRS = null;
            XmlSerializer oSerializer = null;
            System.IO.StringWriter oWriter = null;
            System.IO.StringReader oReader = null;

            oSerializer = new XmlSerializer(typeof(wmCarInfoIn.OTA_VehLocDetailRQ));
            ...
            {
                oSerializer = null;
                oSerializer = new XmlSerializer(@type: typeof(wmCarInfoOut.OTA_VehLocDetailRS));
                oReader = new System.IO.StringReader(xmlMessage);
                oCarInfoRS = (wmCarInfoOut.OTA_VehLocDetailRS)oSerializer.Deserialize(oReader);
            }
            catch (Exception ex)
            {
        ...
        public string wmCarInfoXml(string xmlRequest)
        {
