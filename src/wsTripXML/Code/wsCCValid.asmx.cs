...
namespace wsTripXML.wsTravelTalk
{
    ...
    [WebService(Namespace = "http://tripxml.downtowntravel.com/tripxml/wsCCValid", Name = "wsCCValid", Description = "A TripXML Web Service to Process Credit Card Validation Messages Request.")]
    public class wsCCValid : WebService
    {
        ...
        [WebMethod(Description = "Process Credit Card Validation Xml Messages Request.")]
