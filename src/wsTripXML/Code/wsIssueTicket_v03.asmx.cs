...
namespace wsTripXML.wsTravelTalk
{
    ...
    [WebService(Namespace = "http://tripxml.downtowntravel.com/tripxml/wsIssueTicket", Name = "wsIssueTicket_v03", Description = "A TripXML Web Service to Process Issue Ticket Messages Request - version 03.")]
    public class wsIssueTicket_v03 : WebService
    {
        public TripXML tXML;

        #region  Web Services Designer Generated Code 

        public wsIssueTicket_v03() : base()
        {
