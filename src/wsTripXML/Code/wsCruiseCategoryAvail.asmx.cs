...
namespace wsTripXML.wsTravelTalk
{
    ...
    [WebService(Namespace = "http://tripxml.downtowntravel.com/tripxml/wsCruiseCategoryAvail", Name = "wsCruiseCategoryAvail", Description = "A TripXML Web Service to Process Cruise Category Availibility Messages Request.")]
    public class wsCruiseCategoryAvail : WebService
    {

        #region  Web Services Designer Generated Code 

        public wsCruiseCategoryAvail() : base()
        {
        ...
        private string DecodeCruiseCategoryAvail(string strResponse, string UserID)
        {
        ...
        private string FilterCruiseCategoryAvail(string strRequest, string UserID)
        {
            XmlDocument oDoc = null;
            XmlElement oRoot = null;
            XmlNode oNode = null;
            ...
            try
            {
                ...
                {
                    if (((oRoot.SelectSingleNode("SailingInfo/InclusivePackageOption")?.Attributes["StartDate"]?.Value) ?? "0") == "0")
                    {
        ...
        private string ServiceRequest(string strRequest, ttServices ttServiceID)
        {
            ...
            finally
            {
                ...
                if (modCore.Trace)
                    CoreLib.SendTrace(ttCredential.UserID, "wsCruiseCategoryAvail", "============= OTA Response ============= ", strResponse, UUID);
            }
            sb = null;
            return strResponse;
        ...
        public wmCruiseCategoryAvailOut.OTA_CruiseCategoryAvailRS wmCruiseCategoryAvail(wmCruiseCategoryAvailIn.OTA_CruiseCategoryAvailRQ OTA_CruiseCategoryAvailRQ)
        {
            string xmlMessage = "";
            wmCruiseCategoryAvailOut.OTA_CruiseCategoryAvailRS oCruiseCategoryAvailRS = null;
            XmlSerializer oSerializer = null;
            System.IO.StringWriter oWriter = null;
            System.IO.StringReader oReader = null;

            oSerializer = new XmlSerializer(typeof(wmCruiseCategoryAvailIn.OTA_CruiseCategoryAvailRQ));
            ...
            {
                oSerializer = null;
                oSerializer = new XmlSerializer(@type: typeof(wmCruiseCategoryAvailOut.OTA_CruiseCategoryAvailRS));
                oReader = new System.IO.StringReader(xmlMessage);
                oCruiseCategoryAvailRS = (wmCruiseCategoryAvailOut.OTA_CruiseCategoryAvailRS)oSerializer.Deserialize(oReader);
            }
            catch (Exception ex)
            {
        ...
        [WebMethod(Description = "Process Cruise Category Availibility Xml Messages Request.")]
        public string wmCruiseCategoryAvailXml(string xmlRequest)
        {
