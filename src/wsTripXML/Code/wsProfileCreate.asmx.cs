...
namespace wsTripXML.wsTravelTalk
{
    ...
    [WebService(Namespace = "http://tripxml.downtowntravel.com/tripxml/wsProfileCreate", Name = "wsProfileCreate", Description = "A TripXML Web Service to Process Profile Create Request.")]


    public class wsProfileCreate : WebService
    {
        public TripXML tXML;

        #region  Web Services Designer Generated Code 

        public wsProfileCreate() : base()
        {
        ...
        private string DecodeProfileCreate(string strResponse, string UserID)
        {
        ...
        private string ServiceRequest(string strRequest, ttServices ttServiceID)
        {
            ...
            finally
            {
                ...
                if (modCore.Trace)
                    CoreLib.SendTrace(ttCredential.UserID, "wsProfileCreate", "============= OTA Response ============= ", strResponse, UUID);
            }
        ...
        [WebMethod(Description = "Process Profile Create Messages Request.")]
        [System.Web.Services.Protocols.SoapHeader("tXML")]
        public wmProfileReadOut.OTA_ProfileReadRS wmProfileCreate(wmProfileCreateIn.OTA_ProfileCreateRQ OTA_ProfileCreateRQ)
        {
            string xmlMessage = "";
            ...
            oSerializer = new XmlSerializer(typeof(wmProfileCreateIn.OTA_ProfileCreateRQ));
        ...
        public string wmProfileCreateXml(string xmlRequest)
        {
