...
namespace wsTripXML.wsTravelTalk
{
    ...
    [WebService(Namespace = "http://tripxml.downtowntravel.com/tripxml/wsAirRules", Name = "wsAirRules", Description = "A TripXML Web Service to Process Air Rules Messages Request.")]
    public class wsAirRules : WebService
    {
        ...
        public wmAirRulesOut.OTA_AirRulesRS wmAirRules(wmAirRulesIn.OTA_AirRulesRQ OTA_AirRulesRQ)
        {
            string xmlMessage = "";
            wmAirRulesOut.OTA_AirRulesRS oAirRulesRS = null;
            XmlSerializer oSerializer = null;
            System.IO.StringWriter oWriter = null;
            System.IO.StringReader oReader = null;

            oSerializer = new XmlSerializer(typeof(wmAirRulesIn.OTA_AirRulesRQ));
            ...
            {
                oSerializer = null;
                oSerializer = new XmlSerializer(@type: typeof(wmAirRulesOut.OTA_AirRulesRS));
                oReader = new System.IO.StringReader(xmlMessage);
                oAirRulesRS = (wmAirRulesOut.OTA_AirRulesRS)oSerializer.Deserialize(oReader);
            }
            catch (Exception ex)
            {
