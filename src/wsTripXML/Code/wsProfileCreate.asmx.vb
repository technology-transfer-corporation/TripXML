...
Namespace wsTravelTalk
    ...
    <System.Web.Services.Protocols.SoapDocumentService(RoutingStyle:=System.Web.Services.Protocols.SoapServiceRoutingStyle.RequestElement), _
        System.Web.Services.WebService(Namespace:="http://tripxml.downtowntravel.com/tripxml/wsProfileCreate", _
        Name:="wsProfileCreate", _
        Description:="A TripXML Web Service to Process Profile Create Request.")> _
    Public Class wsProfileCreate
...
#Region " Decode Function "
        ...
        Private Function DecodeProfileCreate(ByVal strResponse As String, ByVal UserID As String) As String
            ...
            Try
                ...
                For Each oNode In oRoot.SelectNodes("TravelItinerary/ItineraryInfo/ReservationItems/Item/Air")
                    ...
                    Catch e As Exception
                        CoreLib.SendTrace(UserID, "wsProfileCreate", "Error *** Decoding AirAvail Response", e.Message, String.Empty)
                    End Try
            ...
            Catch ex As Exception
                CoreLib.SendTrace(UserID, "wsProfileCreate", "Error *** Decoding AirAvail Response", ex.Message, String.Empty)
            End Try
            Return strResponse
        End Function
...
#Region " Process Service Request All GDS "
        ...
        Private Function ServiceRequest(ByVal strRequest As String, ByVal ttServiceID As Integer) As String
            ...
            Try
                ...
                strResponse = DecodeProfileCreate(strResponse, ttCredential.UserID)
            ...
            Finally
                ...
                If Trace Then CoreLib.SendTrace(ttCredential.UserID, "wsProfileCreate", "============= OTA Response ============= ", strResponse, UUID)
            End Try
...
#Region " Web Methods "
        ...
        <WebMethod(Description:="Process Profile Create Messages Request.")> _
        <System.Web.Services.Protocols.SoapHeader("tXML")> _
        Public Function wmProfileCreate(ByVal OTA_ProfileCreateRQ As wmProfileCreateIn.OTA_ProfileCreateRQ) As <XmlElementAttribute("OTA_ProfileReadRS")> wmProfileReadOut.OTA_ProfileReadRS
            ...
            oSerializer = New XmlSerializer(GetType(wmProfileCreateIn.OTA_ProfileCreateRQ))
            oWriter = New System.IO.StringWriter(New System.Text.StringBuilder)
            oSerializer.Serialize(oWriter, OTA_ProfileCreateRQ)
            xmlMessage = oWriter.ToString
            xmlMessage = xmlMessage.Replace(" xmlns:xsi=""http://www.w3.org/2001/XMLSchema-instance"" xmlns:xsd=""http://www.w3.org/2001/XMLSchema""", "")

            xmlMessage = ServiceRequest(xmlMessage, ttServices.ProfileCreate)
            ...
            Catch ex As Exception
                CoreLib.SendTrace("", "wsProfileCreate", "Error Deserialing OTA Response", ex.Message, String.Empty)
            End Try
        ...
        Public Function wmProfileCreateXml(ByVal xmlRequest As String) As String
            Return ServiceRequest(xmlRequest, ttServices.ProfileCreate)
        End Function
