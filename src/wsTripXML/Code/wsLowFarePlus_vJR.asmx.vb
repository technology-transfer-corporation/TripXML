...
#Region " Process Service Request All GDS "
        ...
        Private Function ServiceRequest(ByVal strRequest As String, ByVal ttServiceID As Integer) As String
            ...
            Dim DoAmadeusWSSearches(99) As SearchAmadeusWS_vJR
            Dim DoGalileoSearches(99) As SearchGalileo_vJR
            Dim DoSabreSearches(99) As SearchSabre_vJR
            Dim DoWorldspanSearches(99) As SearchWorldspan_vJR
            ...
            Finally
                ...
                If Trace Then CoreLib.SendTrace(ttCredential.UserID, "wsLowFarePlus_vJR", "============= OTA Response ============= ", strResponse, UUID)
            End Try
...
#Region " Web Methods "
        ...
        Public Function wmLowFarePlus(ByVal OTA_AirLowFareSearchPlusRQ As wmLowFarePlusIn_vJR.OTA_AirLowFareSearchPlusRQ) As <XmlElementAttribute("OTA_AirLowFareSearchPlusRS")> wmLowFarePlusOut_vJR.OTA_AirLowFareSearchPlusRS

            Dim xmlMessage As String = ""
            Dim oLowFarePlusRS As wmLowFarePlusOut_vJR.OTA_AirLowFareSearchPlusRS = Nothing
            Dim oSerializer As XmlSerializer = Nothing
            Dim oWriter As System.IO.StringWriter = Nothing
            Dim oReader As System.IO.StringReader = Nothing

            oSerializer = New XmlSerializer(GetType(wmLowFarePlusIn_vJR.OTA_AirLowFareSearchPlusRQ))
            ...
            Try
                oSerializer = Nothing
                oSerializer = New XmlSerializer(Type:=GetType(wmLowFarePlusOut_vJR.OTA_AirLowFareSearchPlusRS))
                oReader = New System.IO.StringReader(xmlMessage)
                oLowFarePlusRS = CType(oSerializer.Deserialize(oReader), wmLowFarePlusOut_vJR.OTA_AirLowFareSearchPlusRS)
            Catch ex As Exception
