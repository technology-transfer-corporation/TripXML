...
namespace wsTripXML.wsTravelTalk
{
    ...
    [WebService(Namespace = "http://tripxml.downtowntravel.com/tripxml/wsCruiseCabinHold", Name = "wsCruiseCabinHold", Description = "A TripXML Web Service to Process Cruise Cabin Hold Messages Request.")]
    public class wsCruiseCabinHold : WebService
    {

        #region  Web Services Designer Generated Code 

        public wsCruiseCabinHold() : base()
        {
        ...
        [WebMethod(Description = "Process Cruise Cabin Hold Xml Messages Request.")]
