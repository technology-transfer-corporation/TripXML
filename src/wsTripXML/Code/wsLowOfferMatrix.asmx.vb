...
#Region " Decode Functions "
        ...
        Private Function DecodeLowOfferMatrix(ByVal strResponse As String, ByVal UserID As String) As String
...
#Region " Process Service Request All GDS "
        ...
        Private Function ServiceRequest(ByVal strRequest As String, ByVal ttServiceID As Integer) As String
            ...
            Dim doAmadeusWsSearches(99) As SearchAmadeusOfferMatrixWS
                            ...
                            Case "amadeus"
                                Try
                                    ...
                                    If ttProviderSystems.AmadeusWS = True Then
                                        ...
                                        doAmadeusWsSearches(i) = New SearchAmadeusOfferMatrixWS(.Providers(i).PCC, .UserID, .System, ttProviderSystems, oAmadeusWS)
            ...
            Finally
                ...
                If Trace Then CoreLib.SendTrace(ttCredential.UserID, "wsLowOfferMatrix", "============= OTA Response ============= ", strResponse, UUID)
            End Try
...
#Region " Web Methods "
        ...
        Public Function wmLowOfferMatrix(ByVal OTA_AirLowOfferMatrixRQ As wmLowOfferMatrixIn.OTA_AirLowOfferMatrixRQ) As <XmlElementAttribute("OTA_AirLowOfferMatrixRS")> wmLowOfferMatrixOut.OTA_AirLowOfferMatrixRS
            ...
            Dim oLowOfferMatrixRS As wmLowOfferMatrixOut.OTA_AirLowOfferMatrixRS = Nothing
            Dim oSerializer As XmlSerializer = Nothing
            Dim oWriter As System.IO.StringWriter = Nothing
            Dim oReader As System.IO.StringReader = Nothing

            oSerializer = New XmlSerializer(GetType(wmLowOfferMatrixIn.OTA_AirLowOfferMatrixRQ))
        ...
        Public Function wmLowOfferMatrixXml(ByVal xmlRequest As String) As String
