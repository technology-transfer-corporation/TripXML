...
namespace wsTripXML.wsTravelTalk
{
    ...
    [WebService(Namespace = "http://tripxml.downtowntravel.com/tripxml/wsVoidTicket", Name = "wsVoidTicket", Description = "A TripXML Web Service to Process Void Ticket Messages Request.")]
    public class wsVoidTicket : WebService
    {
        public TripXML tXML;

        #region  Web Services Designer Generated Code 

        public wsVoidTicket() : base()
        {
