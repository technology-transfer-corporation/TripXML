...
namespace wsTripXML.wsTravelTalk
{
    ...
    [WebService(Namespace = "http://tripxml.downtowntravel.com/tripxml/wsFareDisplay", Name = "wsFareDisplay", Description = "A TripXML Web Service to Process Air Fare Display Messages Request.")]


    public class wsFareDisplay : WebService
    {
        public TripXML tXML;

        #region  Web Services Designer Generated Code 

        public wsFareDisplay() : base()
        {
        ...
        [WebMethod(Description = "Process Air Fare Display Messages Request.")]
        [SoapHeader("tXML")]
        ...
        [WebMethod(Description = "Process Air Fare Display Xml Messages Request.")]
