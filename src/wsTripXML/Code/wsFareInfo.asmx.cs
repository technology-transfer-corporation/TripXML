...
namespace wsTripXML.wsTravelTalk
{
    ...
    [WebService(Namespace = "http://tripxml.downtowntravel.com/tripxml/wsFareInfo", Name = "wsFareInfo", Description = "A TripXML Web Service to Process Air Fare Info Messages Request.")]


    public class wsFareInfo : WebService
    {

        #region  Web Services Designer Generated Code 

        public wsFareInfo() : base()
        {
