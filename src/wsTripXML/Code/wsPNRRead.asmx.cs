...
namespace wsTripXML.wsTravelTalk
{
    ...
    [WebService(Namespace = "http://tripxml.downtowntravel.com/tripxml/wsPNRRead", Name = "wsPNRRead", Description = "A TripXML Web Service to Process PNR Read Request.")]
    public class wsPNRRead : WebService
    {
        public TripXML tXML;

        #region  Web Services Designer Generated Code 

        public wsPNRRead() : base()
        {
