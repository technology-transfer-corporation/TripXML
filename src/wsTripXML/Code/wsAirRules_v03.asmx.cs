...
namespace wsTripXML.wsTravelTalk
{
    ...
    [WebService(Namespace = "http://tripxml.downtowntravel.com/tripxml/wsAirRules", Name = "wsAirRules_v03", Description = "A TripXML Web Service to Process Air Rules Messages Request - version 03.")]
    public class wsAirRules_v03 : WebService
    {
        ...
        private string DecodeAirRules(string strResponse, string UserID)
        {
            ...
            try
            {
                ...
                foreach (XmlNode oNode in oRoot.SelectNodes("FareRuleResponseInfo/FareRuleInfo"))
                {
                    // *******************
                    // Decode Airports   *
                    // *******************
        ...
        private string ServiceRequest(string strRequest, ttServices ttServiceID)
        {
            ...
            finally
            {
                ...
                if (modCore.Trace)
                    CoreLib.SendTrace(ttCredential.UserID, "wsAirRules", "============= OTA Response ============= ", strResponse, ttProviderSystems.LogUUID);
            }
        ...
        public wmAirRulesOut_v03.OTA_AirRulesRS wmAirRules(wmAirRulesIn_v03.OTA_AirRulesRQ OTA_AirRulesRQ)
        {
            string xmlMessage = "";
            wmAirRulesOut_v03.OTA_AirRulesRS oAirRulesRS = null;
            XmlSerializer oSerializer = null;
            System.IO.StringWriter oWriter = null;
            System.IO.StringReader oReader = null;

            oSerializer = new XmlSerializer(typeof(wmAirRulesIn_v03.OTA_AirRulesRQ));
            ...
            {
                oSerializer = null;
                oSerializer = new XmlSerializer(@type: typeof(wmAirRulesOut_v03.OTA_AirRulesRS));
                oReader = new System.IO.StringReader(xmlMessage);
                oAirRulesRS = (wmAirRulesOut_v03.OTA_AirRulesRS)oSerializer.Deserialize(oReader);
            }
            catch (Exception ex)
            {
        ...
        [WebMethod(Description = "Process Air Rules Xml Messages Request.")]
        public string wmAirRulesXml(string xmlRequest)
        {
