...
namespace wsTripXML.wsTravelTalk
{
    ...
    [WebService(Namespace = "http://tripxml.downtowntravel.com/tripxml/wsLowFarePlus", Name = "wsLowFarePlus_vJR", Description = "A TripXML Web Service to Process Low Fare Plus Messages Request.")]
    public class wsLowFarePlus_vJR : WebService
    {
        ...
        private string ServiceRequest(string strRequest, ttServices ttServiceID)
        {
            ...
            // Dim DoAmadeusSearches(99) As SearchAmadeus_vJR
            var DoAmadeusWSSearches = new SearchAmadeusWS_vJR[100];
            var DoGalileoSearches = new SearchGalileo_vJR[100];
            var DoSabreSearches = new SearchSabre_vJR[100];
            var DoWorldspanSearches = new SearchWorldspan_vJR[100];
            // Dim DoPortalSearches(99) As SearchPortal_vJR
            // Dim DoPortalXMLSearches(99) As SearchPortalXML_vJR
                            ...
                            case "amadeus":
                                {
                                    try
                                    {
                                        ...
                                        if (ttProviderSystems.AmadeusWS == true)
                                        {
                                            ...
                                            DoAmadeusWSSearches[i] = new SearchAmadeusWS_vJR(withBlock.Providers[i].PCC, withBlock.UserID, withBlock.System, ref ttProviderSystems, ref oAmadeusWS);
                            ...
                            case "galileo":
                                {
                                    try
                                    {
                                        ...
                                        DoGalileoSearches[i] = new SearchGalileo_vJR(withBlock.Providers[i].PCC, withBlock.UserID, withBlock.System, ref ttProviderSystems, ref oGalileo);
                            ...
                            case "Sabre":
                                {
                                    try
                                    {
                                        ...
                                        DoSabreSearches[i] = new SearchSabre_vJR(withBlock.Providers[i].PCC, withBlock.UserID, withBlock.System, ref ttProviderSystems, ref oSabre);
                            ...
                            case "Worldspan":
                                {
                                    try
                                    {
                                        ...
                                        DoWorldspanSearches[i] = new SearchWorldspan_vJR(withBlock.Providers[i].PCC, withBlock.UserID, withBlock.System, ref ttProviderSystems, ref oWorldspan);
            ...
            finally
            {
                ...
                if (modCore.Trace)
                    CoreLib.SendTrace(ttCredential.UserID, "wsLowFarePlus_vJR", "============= OTA Response ============= ", strResponse, UUID);
            }
        ...
        public wmLowFarePlusOut_vJR.OTA_AirLowFareSearchPlusRS wmLowFarePlus(wmLowFarePlusIn_vJR.OTA_AirLowFareSearchPlusRQ OTA_AirLowFareSearchPlusRQ)
        {

            string xmlMessage = "";
            wmLowFarePlusOut_vJR.OTA_AirLowFareSearchPlusRS oLowFarePlusRS = null;
            XmlSerializer oSerializer = null;
            System.IO.StringWriter oWriter = null;
            System.IO.StringReader oReader = null;

            oSerializer = new XmlSerializer(typeof(wmLowFarePlusIn_vJR.OTA_AirLowFareSearchPlusRQ));
            ...
            {
                oSerializer = null;
                oSerializer = new XmlSerializer(@type: typeof(wmLowFarePlusOut_vJR.OTA_AirLowFareSearchPlusRS));
                oReader = new System.IO.StringReader(xmlMessage);
                oLowFarePlusRS = (wmLowFarePlusOut_vJR.OTA_AirLowFareSearchPlusRS)oSerializer.Deserialize(oReader);
            }
            catch (Exception ex)
            {
                CoreLib.SendTrace("", "wsLowFarePlus_vJR", "Error Deserialing OTA Response", ex.Message, string.Empty);
            }
    ...
    // Public Class SearchAmadeus_vJR
    ...
    public class SearchAmadeusWS_vJR
    {
        ...
        public SearchAmadeusWS_vJR(string _pcc, string _userid, string _System, ref TripXMLProviderSystems _ttProviderSystems, ref cServiceAmadeusWS _oAmadeusWS)
        {
    ...
    public class SearchGalileo_vJR
    {
        private delegate void StartSearch_Delegate();
        private StartSearch_Delegate StartSearch_Wrapper;
        private string pcc = "";
        ...
        public SearchGalileo_vJR(string _pcc, string _userid, string _System, ref TripXMLProviderSystems _ttProviderSystems, ref cServiceGalileo _oGalileo)
        {
    ...
    public class SearchSabre_vJR
    {
        ...
        public SearchSabre_vJR(string _pcc, string _userid, string _System, ref TripXMLProviderSystems _ttProviderSystems, ref cServiceSabre _oSabre)
        {
            StartSearch_Wrapper = new StartSearch_Delegate(DoAmadeusSearchWS);
            pcc = _pcc;
            userid = _userid;
    ...
    public class SearchWorldspan_vJR
    {
        private delegate void StartSearch_Delegate();
        private StartSearch_Delegate StartSearch_Wrapper;
        private string pcc = "";
        ...
        public SearchWorldspan_vJR(string _pcc, string _userid, string _System, ref TripXMLProviderSystems _ttProviderSystems, ref cServiceWorldspan _oWorldspan)
        {
            StartSearch_Wrapper = new StartSearch_Delegate(DoAmadeusSearchWS);
            pcc = _pcc;
            userid = _userid;
    ...
    // Public Class SearchPortalXML_vJR
    // Private Delegate Sub StartSearch_Delegate()
