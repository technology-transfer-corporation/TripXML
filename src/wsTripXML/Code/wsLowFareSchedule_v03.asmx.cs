...
namespace wsTripXML.wsTravelTalk
{
    ...
    [WebService(Namespace = "http://tripxml.downtowntravel.com/tripxml/wsLowFareSchedule", Name = "wsLowFareSchedule_v03", Description = "A TripXML Web Service to Process Low Fare Schedule Messages Request.")]
    public class wsLowFareSchedule_v03 : WebService
    {
        ...
        public wsLowFareSchedule_v03() : base()
        {
        ...
        private string ServiceRequest(string strRequest, ttServices ttServiceID)
        {
            ...
            var DoAmadeusWSSearches = new SearchSchAmadeusWS_v03[100];
            ...
            XmlDocument oNDoc = null;
            XmlElement oNRoot = null;
            ...
            try
            {
                ...
                bool testb = false;
                if (oRoot.Attributes["PriorityDirectFlights"] is not null)
                {
                ...
                {
                    ReqValue = 2;
                    LFSchRequestCount = oRoot.SelectNodes("FaringPreferences/FaringPreference").Count * 2;
                }

                NonDirectFlights = testb;
                        ...
                        for (k = 0; k <= loopTo1; k++)
                        {
                            foreach (XmlNode currentONode1 in oRoot.SelectNodes("FaringPreferences/FaringPreference"))
                            {
                                ...
                                if ((ttCredential.Providers[i].PCC ?? "") == (oNode.Attributes["PseudoCityCode"].Value ?? ""))
                                {
                                    ...
                                    if (oRoot.Attributes["OnlineAirlinesOnly"] is not null)
                                    {
                                    ...
                                    if (testb)
                                    {
                                        if (oNRoot.SelectSingleNode("TravelPreferences") is not null)
                                        {
                                            string tt1 = oNRoot.OuterXml;
                                            if (k == 0)
                                            {
                                        ...
                                        case "amadeus":
                                            {
                                                try
                                                {
                                                    ...
                                                    if (ttProviderSystems.AmadeusWS == true)
                                                    {
                                                        ...
                                                        DoAmadeusWSSearches[j] = new SearchSchAmadeusWS_v03(withBlock.Providers[i].PCC, withBlock.UserID, withBlock.System, ref ttProviderSystems, ref oAmadeusWS);
            ...
            finally
            {
                ...
                if (modCore.Trace)
                    CoreLib.SendTrace(ttCredential.UserID, "wsLowFareSchedule_v03", "============= OTA Response ============= ", strResponse, UUID);
            }
        ...
        public wmLowFareScheduleOut.OTA_AirLowFareSearchScheduleRS wmLowFareSchedule(wmLowFareScheduleIn_v03.OTA_AirLowFareSearchScheduleRQ OTA_AirLowFareSearchScheduleRQ)
        {
            ...
            oSerializer = new XmlSerializer(typeof(wmLowFareScheduleIn_v03.OTA_AirLowFareSearchScheduleRQ));
    ...
    public class SearchSchAmadeusWS_v03
    {
        ...
        public SearchSchAmadeusWS_v03(string _pcc, string _userid, string _System, ref TripXMLProviderSystems _ttProviderSystems, ref cServiceAmadeusWS _oAmadeusWS)
        {
