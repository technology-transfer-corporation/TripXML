...
namespace wsTripXML.wsTravelTalk
{
    ...
    [WebService(Namespace = "http://tripxml.downtowntravel.com/tripxml/wsDisplayTicket", Name = "wsDisplayTicket", Description = "A TripXML Web Service to Process Display Ticket Messages Request.")]


    public class wsDisplayTicket : WebService
    {
        public TripXML tXML;

        #region  Web Services Designer Generated Code 

        public wsDisplayTicket() : base()
        {
