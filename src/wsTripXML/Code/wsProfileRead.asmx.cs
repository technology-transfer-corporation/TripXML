...
namespace wsTripXML.wsTravelTalk
{
    ...
    [WebService(Namespace = "http://tripxml.downtowntravel.com/tripxml/wsProfileRead", Name = "wsProfileRead", Description = "A TripXML Web Service to Process Profile Read Request.")]


    public class wsProfileRead : WebService
    {
        public TripXML tXML;

        #region  Web Services Designer Generated Code 

        public wsProfileRead() : base()
        {
