...
namespace wsTripXML.wsTravelTalk
{
    ...
    [WebService(Namespace = "http://tripxml.downtowntravel.com/tripxml/wsLowOfferSearch", Name = "wsLowOfferSearch", Description = "A TripXML Web Service to Process Low Offer Search Messages Request.")]
    public class wsLowOfferSearch : WebService
    {
        ...
        private string DecodeLowOfferSearch(string strResponse, string UserID)
        {
        ...
        private string ServiceRequest(string strRequest, ttServices ttServiceID)
        {
            ...
            var DoAmadeusWSSearches = new SearchAmadeusOfferSearchWS[100];
                            ...
                            case "amadeus":
                                {
                                    try
                                    {
                                        ...
                                        if (ttProviderSystems.AmadeusWS == true)
                                        {
                                            ...
                                            DoAmadeusWSSearches[i] = new SearchAmadeusOfferSearchWS(withBlock.Providers[i].PCC, withBlock.UserID, withBlock.System, ref ttProviderSystems, ref oAmadeusWS);
            ...
            finally
            {
                ...
                if (modCore.Trace)
                    CoreLib.SendTrace(ttCredential.UserID, "wsLowOfferSearch", "============= OTA Response ============= ", strResponse, UUID);
            }
        ...
        public wmLowOfferSearchOut.OTA_AirLowOfferSearchRS wmLowOfferSearch(wmLowOfferSearchIn.OTA_AirLowOfferSearchRQ OTA_AirLowOfferSearchRQ)
        {

            string xmlMessage = "";
            wmLowOfferSearchOut.OTA_AirLowOfferSearchRS oLowOfferSearchRS = null;
            XmlSerializer oSerializer = null;
            System.IO.StringWriter oWriter = null;
            System.IO.StringReader oReader = null;

            oSerializer = new XmlSerializer(typeof(wmLowOfferSearchIn.OTA_AirLowOfferSearchRQ));
            ...
            {
                oSerializer = null;
                oSerializer = new XmlSerializer(@type: typeof(wmLowOfferSearchOut.OTA_AirLowOfferSearchRS));
                oReader = new System.IO.StringReader(xmlMessage);
                oLowOfferSearchRS = (wmLowOfferSearchOut.OTA_AirLowOfferSearchRS)oSerializer.Deserialize(oReader);
            }
            catch (Exception ex)
            {
        ...
        [WebMethod(Description = "Process Low Fare Search Xml Messages Request.")]
        public string wmLowOfferSearchXml(string xmlRequest)
        {
    ...
    public class SearchAmadeusOfferSearchWS
    {
        ...
        public SearchAmadeusOfferSearchWS(string _pcc, string _userid, string _System, ref TripXMLProviderSystems _ttProviderSystems, ref cServiceAmadeusWS _oAmadeusWS)
        {
