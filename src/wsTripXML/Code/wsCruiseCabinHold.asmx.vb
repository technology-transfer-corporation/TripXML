...
Namespace wsTravelTalk
    ...
    <System.Web.Services.WebService(Namespace:="http://tripxml.downtowntravel.com/tripxml/wsCruiseCabinHold",
        Name:="wsCruiseCabinHold",
        Description:="A TripXML Web Service to Process Cruise Cabin Hold Messages Request.")>
    Public Class wsCruiseCabinHold
...
#Region " Decode Function "
        ...
        Private Function DecodeCruiseCabinHold(ByVal strResponse As String, ByVal UserID As String) As String
        ...
        Private Function FilterCruiseCabinHold(ByVal strRequest As String, ByVal UserID As String) As String
            Dim oDoc As XmlDocument = Nothing
            Dim oRoot As XmlElement = Nothing
            Dim oNode As XmlNode = Nothing
            ...
            Try
                ...
                If CType((GetCruiseFilterValue(ttCruiseProfiles, mstrVendorCode, "currencyRequiredFareAvailabilityRequest") = "true"), Boolean) Then
                    ...
                    ElseIf String.IsNullOrEmpty(oRoot.SelectSingleNode("Currency")?.Attributes("CurrencyCode")?.Value) Then
                        Throw New Exception("Currency Code is mandatory for this Cruise line.")
...
#Region " Process Service Request All GDS "
        ...
        Private Function ServiceRequest(ByVal strRequest As String, ByVal ttServiceID As ttServices) As String
            ...
            Finally
                ...
                If Trace Then CoreLib.SendTrace(ttCredential.UserID, "wsCruiseCabinHold", "============= OTA Response ============= ", strResponse, UUID)
            End Try
            sb = Nothing
            Return strResponse
...
#Region " Web Methods "
        ...
        <WebMethod(Description:="Process Cruise Cabin Hold Messages Request.")>
        Public Function wmCruiseCabinHold(ByVal OTA_CruiseCabinHoldRQ As wmCruiseCabinHoldIn.OTA_CruiseCabinHoldRQ) As <XmlElementAttribute("OTA_CruiseCabinHoldRS")> wmCruiseCabinHoldOut.OTA_CruiseCabinHoldRS
            Dim xmlMessage As String = ""
            Dim oCruiseCabinHoldRS As wmCruiseCabinHoldOut.OTA_CruiseCabinHoldRS = Nothing
            Dim oSerializer As XmlSerializer = Nothing
            Dim oWriter As System.IO.StringWriter = Nothing
            Dim oReader As System.IO.StringReader = Nothing

            oSerializer = New XmlSerializer(GetType(wmCruiseCabinHoldIn.OTA_CruiseCabinHoldRQ))
            ...
            Try
                oSerializer = Nothing
                oSerializer = New XmlSerializer(type:=GetType(wmCruiseCabinHoldOut.OTA_CruiseCabinHoldRS))
                oReader = New System.IO.StringReader(xmlMessage)
                oCruiseCabinHoldRS = CType(oSerializer.Deserialize(oReader), wmCruiseCabinHoldOut.OTA_CruiseCabinHoldRS)
            Catch ex As Exception
        ...
        <WebMethod(Description:="Process Cruise Cabin Hold Xml Messages Request.")> _
        Public Function wmCruiseCabinHoldXml(ByVal xmlRequest As String) As String
