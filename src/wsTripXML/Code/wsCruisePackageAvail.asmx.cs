...
namespace wsTripXML.wsTravelTalk
{
    ...
    [WebService(Namespace = "http://tripxml.downtowntravel.com/tripxml/wsCruisePackageAvail", Name = "wsCruisePackageAvail", Description = "A TripXML Web Service to Process Cruise Package Availibility Messages Request.")]
    public class wsCruisePackageAvail : WebService
    {

        #region  Web Services Designer Generated Code 

        public wsCruisePackageAvail() : base()
        {
        ...
        private string DecodeCruisePackageAvail(string strResponse, string UserID)
        {
        ...
        private string FilterCruisePackageAvail(string strRequest, string UserID)
        {
            XmlDocument oDoc = null;
            XmlElement oRoot = null;
            XmlNode oNode = null;
        ...
        private string ServiceRequest(string strRequest, ttServices ttServiceID)
        {
            ...
            finally
            {
                ...
                if (modCore.Trace)
                    CoreLib.SendTrace(ttCredential.UserID, "wsPackageAvail", "============= OTA Response ============= ", strResponse, UUID);
            }
        ...
        public wmCruisePackageAvailOut.OTA_CruisePackageAvailRS wmCruisePackageAvail(wmCruisePackageAvailIn.OTA_CruisePackageAvailRQ OTA_CruisePackageAvailRQ)
        {
            string xmlMessage = "";
            wmCruisePackageAvailOut.OTA_CruisePackageAvailRS oCruisePackageAvailRS = null;
            XmlSerializer oSerializer = null;
            System.IO.StringWriter oWriter = null;
            System.IO.StringReader oReader = null;

            oSerializer = new XmlSerializer(typeof(wmCruisePackageAvailIn.OTA_CruisePackageAvailRQ));
            ...
            {
                oSerializer = null;
                oSerializer = new XmlSerializer(@type: typeof(wmCruisePackageAvailOut.OTA_CruisePackageAvailRS));
                oReader = new System.IO.StringReader(xmlMessage);
                oCruisePackageAvailRS = (wmCruisePackageAvailOut.OTA_CruisePackageAvailRS)oSerializer.Deserialize(oReader);
            }
            catch (Exception ex)
            {
        ...
        public string wmCruisePackageAvailXml(string xmlRequest)
        {
