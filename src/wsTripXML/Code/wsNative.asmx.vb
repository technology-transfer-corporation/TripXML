...
Namespace wsTravelTalk
    ...
    <System.Web.Services.Protocols.SoapDocumentService(RoutingStyle:=System.Web.Services.Protocols.SoapServiceRoutingStyle.RequestElement), _
        System.Web.Services.WebService(Namespace:="http://tripxml.downtowntravel.com/tripxml/wsNative", _
        Name:="wsNative", _
        Description:="A TripXML Web Service to Process Native Messages Request.")> _
...
#Region " Web Methods "
        ...
        <WebMethod(Description:="Process Native Messages Request.")> _
        ...
        <WebMethod(Description:="Process Native Xml Messages Request.")> _
...
End Namespace
>>>>>>> de45fbe9b52e934c18b71431cf78f4be868bb4b8
