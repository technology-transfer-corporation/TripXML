...
Namespace wsTravelTalk
    ...
    <System.Web.Services.Protocols.SoapDocumentService(RoutingStyle:=System.Web.Services.Protocols.SoapServiceRoutingStyle.RequestElement), _
        System.Web.Services.WebService(Namespace:="http://tripxml.downtowntravel.com/tripxml/wsLowFareMatrix", _
        Name:="wsLowFareMatrix", _
        Description:="A TripXML Web Service to Process Low Fare Matrix Messages Request.")> _
...
#Region " Decode Functions "
        ...
        Private Function DecodeLowFareMatrix(ByVal strResponse As String, ByVal UserID As String) As String
...
#Region " Process Service Request All GDS "
        ...
        Private Function ServiceRequest(ByVal strRequest As String, ByVal ttServiceID As Integer) As String
            ...
            Dim DoAmadeusWSSearches(99) As SearchAmadeusMatrixWS
            Dim DoGalileoSearches(99) As SearchGalileoMatrix
            Dim DoSabreSearches(99) As SearchSabreMatrix
            Dim DoWorldspanSearches(99) As SearchWorldspanMatrix
                        ...
                        Select Case .Providers(i).Name.ToLower
                            Case "amadeus"
                                Try
                                    ...
                                    If ttProviderSystems.AmadeusWS = True Then
                                        ...
                                        DoAmadeusWSSearches(i) = New SearchAmadeusMatrixWS(.Providers(i).PCC, .UserID, .System, ttProviderSystems, oAmadeusWS)
                            ...
                            Case "apollo", "galileo"
                                Try
                                    ...
                                    DoGalileoSearches(i) = New SearchGalileoMatrix(.Providers(i).PCC, .UserID, .System, ttProviderSystems, oGalileo)
                            ...
                            Case "sabre", "Sabre"
                                Try
                                    ...
                                    DoSabreSearches(i) = New SearchSabreMatrix(.Providers(i).PCC, .UserID, .System, ttProviderSystems, oSabre)
                            ...
                            Case "worldspan", "Worldspan"
                                Try
                                    ...
                                    DoWorldspanSearches(i) = New SearchWorldspanMatrix(.Providers(i).PCC, .UserID, .System, ttProviderSystems, oWorldspan)
            ...
            Finally
                ...
                If Trace Then CoreLib.SendTrace(ttCredential.UserID, "wsLowFareMatrix", "============= OTA Response ============= ", strResponse, UUID)
            End Try
...
#Region " Web Methods "
        ...
        Public Function wmLowFareMatrix(ByVal OTA_AirLowFareSearchMatrixRQ As wmLowFareMatrixIn.OTA_AirLowFareSearchMatrixRQ) As <XmlElementAttribute("OTA_AirLowFareSearchMatrixRS")> wmLowFareMatrixOut.OTA_AirLowFareSearchMatrixRS

            Dim xmlMessage As String = ""
            Dim oLowFareMatrixRS As wmLowFareMatrixOut.OTA_AirLowFareSearchMatrixRS = Nothing
            Dim oSerializer As XmlSerializer = Nothing
            Dim oWriter As System.IO.StringWriter = Nothing
            Dim oReader As System.IO.StringReader = Nothing

            oSerializer = New XmlSerializer(GetType(wmLowFareMatrixIn.OTA_AirLowFareSearchMatrixRQ))
            ...
            Try
                oSerializer = Nothing
                oSerializer = New XmlSerializer(Type:=GetType(wmLowFareMatrixOut.OTA_AirLowFareSearchMatrixRS))
                oReader = New System.IO.StringReader(xmlMessage)
                oLowFareMatrixRS = CType(oSerializer.Deserialize(oReader), wmLowFareMatrixOut.OTA_AirLowFareSearchMatrixRS)
            Catch ex As Exception
        ...
        <WebMethod(Description:="Process Low Fare Matrix Xml Messages Request.")> _
        Public Function wmLowFareMatrixXml(ByVal xmlRequest As String) As String
