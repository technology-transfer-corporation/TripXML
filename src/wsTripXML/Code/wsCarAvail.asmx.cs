...
namespace wsTripXML.wsTravelTalk
{
    ...
    [WebService(Namespace = "http://tripxml.downtowntravel.com/tripxml/wsCarAvail", Name = "wsCarAvail", Description = "A TripXML Web Service to Process Car Availability Messages Request.")]
    public class wsCarAvail : WebService
    {
        private StringBuilder sb = new StringBuilder();

        #region  Web Services Designer Generated Code 

        public wsCarAvail() : base()
        {
