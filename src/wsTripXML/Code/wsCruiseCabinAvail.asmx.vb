...
Namespace wsTravelTalk
    ...
    <System.Web.Services.WebService(Namespace:="http://tripxml.downtowntravel.com/tripxml/wsCruiseCabinAvail", _
        Name:="wsCruiseCabinAvail", _
        Description:="A TripXML Web Service to Process Cruise Cabin Availibility Messages Request.")> _
    Public Class wsCruiseCabinAvail
...
#Region " Decode Function "
        ...
        Private Function DecodeCruiseCabinAvail(ByVal strResponse As String, ByVal UserID As String) As String
        ...
        Private Function FilterCruiseCabinAvail(ByVal strRequest As String, ByVal UserID As String) As String
            Dim oDoc As XmlDocument = Nothing
            Dim oRoot As XmlElement = Nothing
            Dim oNode As XmlNode = Nothing
            ...
            Try
                ...
                ' Check Cabin Filters
                For Each oNode In oRoot.SelectNodes("SailingInfo/SelectedCategory/CabinFilters/CabinFilter")
                    If Not oNode.Attributes("CabinFilterCode") Is Nothing Then
                        If Not IsCruiseFilterValue(ttCruiseCabinFilter, VendorCode, oNode.Attributes("CabinFilterCode").Value) Then
...
#Region " Process Service Request All GDS "
        ...
        Private Function ServiceRequest(ByVal strRequest As String, ByVal ttServiceID As Integer) As String
            ...
            Finally
                ...
                If Trace Then CoreLib.SendTrace(ttCredential.UserID, "wsCabinAvail", "============= OTA Response ============= ", strResponse, UUID)
            End Try
...
#Region " Web Methods "
        ...
        <WebMethod(Description:="Process Cruise Cabin Availability Messages Request.")> _
        Public Function wmCruiseCabinAvail(ByVal OTA_CruiseCabinAvailRQ As wmCruiseCabinAvailIn.OTA_CruiseCabinAvailRQ) As <XmlElementAttribute("OTA_CruiseCabinAvailRS")> wmCruiseCabinAvailOut.OTA_CruiseCabinAvailRS
            Dim xmlMessage As String = ""
            Dim oCruiseCabinAvailRS As wmCruiseCabinAvailOut.OTA_CruiseCabinAvailRS = Nothing
            Dim oSerializer As XmlSerializer = Nothing
            Dim oWriter As System.IO.StringWriter = Nothing
            Dim oReader As System.IO.StringReader = Nothing

            oSerializer = New XmlSerializer(GetType(wmCruiseCabinAvailIn.OTA_CruiseCabinAvailRQ))
            ...
            Try
                oSerializer = Nothing
                oSerializer = New XmlSerializer(Type:=GetType(wmCruiseCabinAvailOut.OTA_CruiseCabinAvailRS))
                oReader = New System.IO.StringReader(xmlMessage)
                oCruiseCabinAvailRS = CType(oSerializer.Deserialize(oReader), wmCruiseCabinAvailOut.OTA_CruiseCabinAvailRS)
            Catch ex As Exception
        ...
        <WebMethod(Description:="Process Cruise Cabin Availibility Xml Messages Request.")> _
        Public Function wmCruiseCabinAvailXml(ByVal xmlRequest As String) As String
