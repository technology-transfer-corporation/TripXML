...
#Region " Process Service Request All GDS "
        ...
        Private Function ServiceRequest(ByVal strRequest As String, ByVal ttServiceID As Integer) As String
            ...
            Finally
                ...
                If Trace Then CoreLib.SendTrace(ttCredential.UserID, "wsCCValid", "============= OTA Response ============= ", strResponse, ttProviderSystems.LogUUID)
            End Try
...
#Region " Web Methods "
        ...
        Public Function wmCCValid(ByVal OTA_CCValidRQ As wmCCValidIn.OTA_CCValidRQ) As <XmlElementAttribute("OTA_CCValidRS")> wmCCValidOut.OTA_CCValidRS
            ...
            oSerializer = New XmlSerializer(GetType(wmCCValidIn.OTA_CCValidRQ))
        ...
        <WebMethod(Description:="Process Credit Card Validation Xml Messages Request.")> _
        Public Function wmCCValidXml(ByVal xmlRequest As String) As String
