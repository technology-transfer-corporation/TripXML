...
namespace wsTripXML.wsTravelTalk
{
    ...
    [WebService(Namespace = "http://tripxml.downtowntravel.com/tripxml/wsTravelBuild", Name = "wsTravelBuild_v04", Description = "A TripXML Web Service to Process Travel Build Request - version 04")]
    public class wsTravelBuild_v04 : WebService
    {
        public TripXML tXML;

        #region  Web Services Designer Generated Code 

        public wsTravelBuild_v04() : base()
        {
