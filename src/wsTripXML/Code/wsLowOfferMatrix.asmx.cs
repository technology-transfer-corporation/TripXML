...
namespace wsTripXML.wsTravelTalk
{
    ...
    [WebService(Namespace = "http://tripxml.downtowntravel.com/tripxml/wsLowOfferMatrix", Name = "wsLowOfferMatrix", Description = "A TripXML Web Service to Process Low Offer Matrix Messages Request.")]
    public class wsLowOfferMatrix : WebService
    {
