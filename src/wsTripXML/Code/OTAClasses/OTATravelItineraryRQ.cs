...
namespace wsTripXML.wsTravelTalk.wmTravelItineraryIn
{
    ...
    public class PNRData
    {
        ...
        [XmlAttribute()]
        public string ProfileCompanyName;
    ...
    public class AgencyDataCommission
    {
        ...
        [XmlAttribute()]
        public decimal InfantAmount;

        [XmlIgnore()]
        public bool InfantAmountSpecified;

        [XmlAttribute()]
        public decimal InfantPercent;

        [XmlIgnore()]
        public bool InfantPercentSpecified;
    }
