...
'
Namespace wsTravelTalk.wmCurConvIn
    ...
    Public Class CurrencyRequest
        ...
        '<remarks/>
        Public FromCurrencyCode As String

        '<remarks/>
        Public ToCurrencyCode As String
    End Class
    ...
    Public Class OTA_CurConvRQ
        ...
        '<remarks/>
        <System.Xml.Serialization.XmlElementAttribute("CurrencyRequest")> _
        Public CurrencyRequest() As CurrencyRequest
    End Class
