...
namespace wsTripXML.wsTravelTalk.wmLowFarePlusIn_v03
{
    ...
    [XmlRoot(IsNullable = false)]
    [KnownType(typeof(AirportLocation))]
    public class DestinationLocation : AirportLocation
    {
    ...
    [XmlRoot(IsNullable = false)]
    [KnownType(typeof(AirportLocation))]
    public class OriginLocation : AirportLocation
    {
    ...
    [XmlRoot(IsNullable = false)]
    [KnownType(typeof(OriginLocation))]
    [KnownType(typeof(DestinationLocation))]
    [KnownType(typeof(DepartureDateTime))]
    [KnownType(typeof(ArrivalDateTime))]
    [KnownType(typeof(ConnectionLocation))]
