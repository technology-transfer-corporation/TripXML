...
'
Namespace wsTravelTalk.wmLowFarePlusOut
    ...
    Public Class TPA_ExtensionsRS
        ...
        '<remarks/>
        <System.Xml.Serialization.XmlTextAttribute()> _
        Public PricingSource As String

        '<remarks/>
        <System.Xml.Serialization.XmlElementAttribute("StopInfo")> _
        Public StopInfo() As StopInfo
    End Class
    ...
    Public Class FareInfo
        ...
        '<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()> _
        Public BreakPoint As BreakPointEnum
