            ...
            Try
                ...
                Select Case ttCredential.Providers(0).Name.ToLower()
                    ...
                    Case Else
                        ...
                        strResponse = SendPaymentRequestTravelport(ttServiceID, ttCredential, ttProviderSystems, strRequest)
                End Select
...
#Region " Web Methods "
        ...
        <WebMethod(Description:="Process List Virtual Credit Cards Xml Request.")>
