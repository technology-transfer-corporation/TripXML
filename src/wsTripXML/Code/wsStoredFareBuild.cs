...
namespace wsTripXML.wsTravelTalk
{
    ...
    [WebService(Namespace = "http://tripxml.downtowntravel.com/tripxml/wsStoredFareBuild", Name = "wsStoredFareBuild", Description = "A TripXML Web Service to Process Stored Fare Build Messages Request.")]


    public class wsStoredFareBuild : WebService
    {

        #region  Web Services Designer Generated Code 

        public wsStoredFareBuild() : base()
        {
