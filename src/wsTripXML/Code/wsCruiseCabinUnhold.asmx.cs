...
namespace wsTripXML.wsTravelTalk
{
    ...
    [WebService(Namespace = "http://tripxml.downtowntravel.com/tripxml/wsCruiseCabinUnhold", Name = "wsCruiseCabinUnhold", Description = "A TripXML Web Service to Process Cruise Cabin Unhold Messages Request.")]
    public class wsCruiseCabinUnUnhold : WebService
    {

        #region  Web Services Designer Generated Code 

        public wsCruiseCabinUnUnhold() : base()
        {
        ...
        [WebMethod(Description = "Process Cruise Cabin Unhold Xml Messages Request.")]
