...
namespace wsTripXML.wsTravelTalk
{
    ...
    [WebService(Namespace = "http://tripxml.downtowntravel.com/tripxml/wsTravelBuild", Name = "wsTravelBuild", Description = "A TripXML Web Service to Process Travel Build Request.")]
    public class wsTravelBuild : WebService
    {
        public TripXML tXML;

        #region  Web Services Designer Generated Code 

        public wsTravelBuild() : base()
        {
        ...
        public wmTravelItineraryOut.OTA_TravelItineraryRS wmTravelBuild(wmTravelItineraryIn.OTA_TravelItineraryRQ OTA_TravelItineraryRQ)
        {
            string xmlMessage = "";
            ...
            oSerializer = new XmlSerializer(typeof(wmTravelItineraryIn.OTA_TravelItineraryRQ));
        ...
        [WebMethod(Description = "Process Travel Build Xml Messages Request.")]
