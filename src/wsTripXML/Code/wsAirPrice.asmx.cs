...
namespace wsTripXML.wsTravelTalk
{
    ...
    [WebService(Namespace = "http://tripxml.downtowntravel.com/tripxml/wsAirPrice", Name = "wsAirPrice", Description = "A TripXML Web Service to Process Air Price Messages Request.")]
    public class wsAirPrice : WebService
    {
        ...
        private string ServiceRequest(string strRequest, ttServices ttServiceID)
        {
            ...
            finally
            {
                ...
                if (modCore.Trace)
                    CoreLib.SendTrace(ttCredential.UserID, "wsAirPrice", "============= OTA Response ============= ", strResponse, ttProviderSystems.LogUUID);
            }
        ...
        [WebMethod(Description = "Process Air Price Xml Messages Request.")]
