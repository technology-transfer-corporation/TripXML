...
namespace wsTripXML.wsTravelTalk
{
    ...
    [WebService(Namespace = "http://tripxml.downtowntravel.com/tripxml/wsPNRSplit", Name = "wsPNRSplit", Description = "A TripXML Web Service to Process PNR Split Request.")]
    public class wsPNRSplit : WebService
    {
        public TripXML tXML;

        #region  Web Services Designer Generated Code 

        public wsPNRSplit() : base()
        {
