...
Namespace wsTravelTalk
    ...
    <System.Web.Services.WebService(Namespace:="http://tripxml.downtowntravel.com/tripxml/wsShowMileage", _
        Name:="wsShowMileage", _
        Description:="A TripXML Web Service to Process Show Mileage Messages Request.")> _
...
#Region " Process Service Request All GDS "
        ...
        Private Function ServiceRequest(ByVal strRequest As String, ByVal ttServiceID As Integer) As String
            ...
            Finally
                ...
                If Trace Then CoreLib.SendTrace(ttCredential.UserID, "wsShowMileage", "============= OTA Response ============= ", strResponse, UUID)
            End Try
            sb = Nothing
            Return strResponse
...
#Region " Web Methods "
        ...
        <WebMethod(Description:="Process Show Mileage Messages Request.")> _
        Public Function wmShowMileage(ByVal OTA_ShowMileageRQ As wmShowMileageIn.OTA_ShowMileageRQ) As <XmlElementAttribute("OTA_ShowMileageRS")> wmShowMileageOut.OTA_ShowMileageRS
            ...
            oSerializer = New XmlSerializer(GetType(wmShowMileageIn.OTA_ShowMileageRQ))
        ...
        <WebMethod(Description:="Process Show Mileage Xml Messages Request.")> _
