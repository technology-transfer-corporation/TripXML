...
Namespace wsTravelTalk
    ...
    <System.Web.Services.Protocols.SoapDocumentService(RoutingStyle:=System.Web.Services.Protocols.SoapServiceRoutingStyle.RequestElement),
            System.Web.Services.WebService(Namespace:="http://tripxml.downtowntravel.com/tripxml/wsIssueTicketSessioned",
            Name:="wsIssueTicketSessioned",
            Description:="A TripXML Web Service to Process Issue ticket with open session")>
    Public Class wsIssueTicketSessioned
...
#Region " Web Methods "
        ...
        Public Function wmIssueTicketSessioned(ByVal TT_IssueTicketRQ As wmIssueTicketSessionedIn.TT_IssueTicketRQ) As <XmlElementAttribute("TT_IssueTicketRS")> wmIssueTicketSessionedOut.TT_IssueTicketRS
            Dim oIssueTicketRS As wmIssueTicketSessionedOut.TT_IssueTicketRS = Nothing
            Dim oSerializer As XmlSerializer
            Dim oWriter As IO.StringWriter
            Dim oReader As IO.StringReader

            oSerializer = New XmlSerializer(GetType(wmIssueTicketSessionedIn.TT_IssueTicketRQ))
            ...
            xmlMessage = ServiceRequest(xmlMessage, ttServices.IssueTicketSessioned)

            Try
                oSerializer = Nothing
                oSerializer = New XmlSerializer(type:=GetType(wmIssueTicketSessionedOut.TT_IssueTicketRS))
                oReader = New IO.StringReader(xmlMessage)
                oIssueTicketRS = CType(oSerializer.Deserialize(oReader), wmIssueTicketSessionedOut.TT_IssueTicketRS)
            Catch ex As Exception
        ...
        Public Function wmIssueTicketSessionedXml(ByVal xmlRequest As String) As String
            Return ServiceRequest(xmlRequest, ttServices.IssueTicketSessioned)
        End Function
