...
namespace wsTripXML.wsTravelTalk
{
    ...
    [WebService(Namespace = "http://tripxml.downtowntravel.com/tripxml/wsQueue", Name = "wsQueue", Description = "A TripXML Web Service to Process Queue Messages Request.")]


    public class wsQueue : WebService
    {
        public TripXML tXML;
        ...
        [WebMethod(Description = "Process Queue Messages Request.")]
        [SoapHeader("tXML")]
        ...
        [WebMethod(Description = "Process Queue well format Xml Messages Request.")]
