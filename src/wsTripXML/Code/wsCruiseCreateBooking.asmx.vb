...
Namespace wsTravelTalk
    ...
    <System.Web.Services.WebService(Namespace:="http://tripxml.downtowntravel.com/tripxml/wsCruiseCreateBooking", _
        Name:="wsCruiseCreateBooking", _
        Description:="A TripXML Web Service to Process Cruise Create Booking Messages Request.")> _
...
#Region " Web Methods "
        ...
        <WebMethod(Description:="Process Cruise Create Booking Messages Request.")> _
