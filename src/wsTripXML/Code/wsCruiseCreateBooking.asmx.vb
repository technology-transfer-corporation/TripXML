...
Namespace wsTravelTalk
    ...
    <System.Web.Services.WebService(Namespace:="http://tripxml.downtowntravel.com/tripxml/wsCruiseCreateBooking",
        Name:="wsCruiseCreateBooking",
        Description:="A TripXML Web Service to Process Cruise Create Booking Messages Request.")>
    Public Class wsCruiseCreateBooking
...
#Region " Decode Function "
        ...
        Private Function DecodeCruiseCreateBooking(ByVal strResponse As String, ByVal UserID As String) As String
        ...
        Private Function FilterCruiseCreateBooking(ByVal strRequest As String, ByVal UserID As String) As String
            Dim oDoc As XmlDocument = Nothing
            Dim oRoot As XmlElement = Nothing
            Dim oNode As XmlNode = Nothing
            ...
            Try
                ...
                For Each oNode In oRoot.SelectNodes("ReservationInfo/GuestDetails/GuestDetail")
                    For Each oNodeChild In oNode.SelectNodes("ContactInfo")
                        ...
                        If GetCruiseFilterValue(ttCruiseProfiles, mstrVendorCode, "emergencyContactInformation") <> "E" Then
                            If oNodeChild.Attributes("EmergencyFlag") IsNot Nothing AndAlso oNodeChild.Attributes("EmergencyFlag").Value = "true" Then
                                Throw New Exception("Emergency contact not supported by this cruise line.")
                            End If
                        End If

                        ' Check Contact Info BirthDate
                        If GetCruiseFilterValue(ttCruiseProfiles, mstrVendorCode, "paxBirthDateSupported") <> "E" Then
                            If oNodeChild.Attributes("BirthDate") IsNot Nothing AndAlso oNodeChild.Attributes("BirthDate").Value.Length > 0 Then
...
#Region " Process Service Request All GDS "
        ...
        Private Function ServiceRequest(ByVal strRequest As String, ByVal ttServiceID As ttServices) As String
            ...
            Finally
                ...
                If Trace Then CoreLib.SendTrace(ttCredential.UserID, "wsCruiseCreateBooking", "============= OTA Response ============= ", strResponse, UUID)
            End Try
...
#Region " Web Methods "
        ...
        Public Function wmCruiseCreateBooking(ByVal OTA_CruiseCreateBookingRQ As wmCruiseCreateBookingIn.OTA_CruiseCreateBookingRQ) As <XmlElementAttribute("OTA_CruiseCreateBookingRS")> wmCruiseCreateBookingOut.OTA_CruiseCreateBookingRS
        ...
        <WebMethod(Description:="Process Cruise Create Booking Xml Messages Request.")> _
        Public Function wmCruiseCreateBookingXml(ByVal xmlRequest As String) As String
