...
namespace wsTripXML.wsTravelTalk
{
    ...
    [WebService(Namespace = "http://tripxml.downtowntravel.com/tripxml/wsCarList", Name = "wsCarList", Description = "A TripXML Web Service to Process Car List Messages Request.")]
    public class wsCarList : WebService
    {
