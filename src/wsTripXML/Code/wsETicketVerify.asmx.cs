...
namespace wsTripXML.wsTravelTalk
{
    ...
    [WebService(Namespace = "http://tripxml.downtowntravel.com/tripxml/wsETicketVerify", Name = "wsETicketVerify", Description = "A TripXML Web Service to Process eTicket Verify Messages Request.")]
    public class wsETicketVerify : WebService
    {

        #region  Web Services Designer Generated Code 

        public wsETicketVerify() : base()
        {
        ...
        [WebMethod(Description = "Process eTicket Verify Xml Messages Request.")]
