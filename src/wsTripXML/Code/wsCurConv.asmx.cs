...
namespace wsTripXML.wsTravelTalk
{
    ...
    [WebService(Namespace = "http://tripxml.downtowntravel.com/tripxml/wsCurConv", Name = "wsCurConv", Description = "A TripXML Web Service to Process Currency Convertion Messages Request.")]


    public class wsCurConv : WebService
    {
        public TripXML tXML;

        #region  Web Services Designer Generated Code 

        public wsCurConv() : base()
        {
        ...
        private string ServiceRequest(string strRequest, ttServices ttServiceID)
        {
            ...
            finally
            {
                ...
                if (modCore.Trace)
                    CoreLib.SendTrace(ttCredential.UserID, "wsCurConv", "============= OTA Response ============= ", strResponse, UUID);
            }
        ...
        [WebMethod(Description = "Process Currency Convertion Messages Request.")]
        [System.Web.Services.Protocols.SoapHeader("tXML")]
        public wmCurConvOut.OTA_CurConvRS wmCurConv(wmCurConvIn.OTA_CurConvRQ OTA_CurConvRQ)
        {
            string xmlMessage = "";
            wmCurConvOut.OTA_CurConvRS oCurConvRS = null;
            XmlSerializer oSerializer = null;
            System.IO.StringWriter oWriter = null;
            System.IO.StringReader oReader = null;

            oSerializer = new XmlSerializer(typeof(wmCurConvIn.OTA_CurConvRQ));
            ...
            {
                oSerializer = null;
                oSerializer = new XmlSerializer(@type: typeof(wmCurConvOut.OTA_CurConvRS));
                oReader = new System.IO.StringReader(xmlMessage);
                oCurConvRS = (wmCurConvOut.OTA_CurConvRS)oSerializer.Deserialize(oReader);
            }
            catch (Exception ex)
            {
        ...
        [WebMethod(Description = "Process Currency Convertion Xml Messages Request.")]
        public string wmCurConvXml(string xmlRequest)
        {
