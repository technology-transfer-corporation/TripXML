...
namespace wsTripXML.wsTravelTalk
{
    ...
    [WebService(Namespace = "http://tripxml.downtowntravel.com/tripxml/wsCruiseModifyBooking", Name = "wsCruiseModifyBooking", Description = "A TripXML Web Service to Process Cruise Modify Booking Messages Request.")]
    public class wsCruiseModifyBooking : WebService
    {

        #region  Web Services Designer Generated Code 

        public wsCruiseModifyBooking() : base()
        {
        ...
        [WebMethod(Description = "Process Cruise Modify Booking Xml Messages Request.")]
