...
#Region " Decode Functions "
        ...
        Private Function DecodeAirSeatMap(ByVal strResponse As String, ByVal UserID As String) As String
            ...
            Try
                ...
                For Each oNode In oRoot.SelectNodes("SeatMapResponses/SeatMapResponse/FlightSegmentInfo")
                    ' *******************
                    ' Decode Airports   *
                    ' *******************
...
#Region " Process Service Request All GDS "
        ...
        Private Function ServiceRequest(ByVal strRequest As String, ByVal ttServiceID As Integer) As String
            ...
            Finally
                ...
                If Trace Then CoreLib.SendTrace(ttCredential.UserID, "wsAirSeatMap", "============= OTA Response ============= ", strResponse, ttProviderSystems.LogUUID)
            End Try
...
#Region " Web Methods "
        ...
        Public Function wmAirSeatMap(ByVal OTA_AirSeatMapRQ As wmAirSeatMapIn.OTA_AirSeatMapRQ) As <XmlElementAttribute("OTA_AirSeatMapRS")> wmAirSeatMapOut.OTA_AirSeatMapRS
            ...
            oSerializer = New XmlSerializer(GetType(wmAirSeatMapIn.OTA_AirSeatMapRQ))
        ...
        <WebMethod(Description:="Process Air Seat Map Xml Messages Request.")> _
        Public Function wmAirSeatMapXml(ByVal xmlRequest As String) As String
