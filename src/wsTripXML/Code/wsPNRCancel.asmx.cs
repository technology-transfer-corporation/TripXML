...
namespace wsTripXML.wsTravelTalk
{
    ...
    [WebService(Namespace = "http://tripxml.downtowntravel.com/tripxml/wsPNRCancel", Name = "wsPNRCancel", Description = "A TripXML Web Service to Process PNR Cancel Request.")]


    public class wsPNRCancel : WebService
    {
        public TripXML tXML;

        #region  Web Services Designer Generated Code 

        public wsPNRCancel() : base()
        {
        ...
        private string ServiceRequest(string strRequest, ttServices ttServiceID)
        {
            ...
            finally
            {
                ...
                if (modCore.Trace)
                    CoreLib.SendTrace(ttCredential.UserID, "wsPNRCancel", "============= OTA Response ============= ", strResponse, UUID);
            }
            sb = null;
            return strResponse;
        ...
        [WebMethod(Description = "Process PNR Cancel Messages Request.")]
        [System.Web.Services.Protocols.SoapHeader("tXML")]
        public wmPNRCancelOut.OTA_CancelRS wmPNRCancel(wmPNRCancelIn.OTA_CancelRQ OTA_CancelRQ)
        {
            string xmlMessage = "";
            wmPNRCancelOut.OTA_CancelRS oPNRCancelRS = null;
            XmlSerializer oSerializer = null;
            System.IO.StringWriter oWriter = null;
            System.IO.StringReader oReader = null;

            oSerializer = new XmlSerializer(typeof(wmPNRCancelIn.OTA_CancelRQ));
            ...
            {
                oSerializer = null;
                oSerializer = new XmlSerializer(@type: typeof(wmPNRCancelOut.OTA_CancelRS));
                oReader = new System.IO.StringReader(xmlMessage);
                oPNRCancelRS = (wmPNRCancelOut.OTA_CancelRS)oSerializer.Deserialize(oReader);
            }
            catch (Exception ex)
            {
        ...
        [WebMethod(Description = "Process PNR Cancel Xml Messages Request.")]
        public string wmPNRCancelXml(string xmlRequest)
        {
