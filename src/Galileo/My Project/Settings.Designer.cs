...
namespace Galileo.My
{
    ...
    internal sealed partial class MySettings : System.Configuration.ApplicationSettingsBase
    {
        ...
        */
        ...
        [System.Configuration.DefaultSettingValue("https://americas.copy-webservices.travelport.com/B2BGateway/service/XMLSelect")]
        public string Galileo_wsGalileoCopy_XmlSelect
        {
            get
            {
                return this["Galileo_wsGalileoCopy_XmlSelect"].ToString();
            }
        }
    }
}
