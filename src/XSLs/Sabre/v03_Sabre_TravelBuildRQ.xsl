...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
      ...
      <AddRemarkRQ xmlns="http://webservices.sabre.com/sabreXML/2011/10" ReturnHostCommand="true" Version="2.1.1">
        <RemarkInfo>
          <Remark Type="Historical">
            ...
            <Text>
              <xsl:value-of select="concat('ASD/TL/',$pcode,'/Thomalex booking')"/>
            </Text>
          </Remark>
  ...
  <xsl:template match="PNRData" mode="other">
    <TravelItineraryAddInfoRQ Version="2.0.2" xmlns="http://webservices.sabre.com/sabreXML/2011/10">
      <AgencyInfo>
        <xsl:if test="Address[@Type='Agency']/StreetNmbr!=''">
          <Address>
            <AddressLine>
  ...
  <xsl:template match="PriceData">
    <xsl:choose>
      <xsl:when test="../../OTA_AirBookRQ/AirItinerary/OriginDestinationOptions/OriginDestinationOption/FlightSegment/@FareFamily!=''">
      ...
      <xsl:otherwise>
        <OTA_AirPriceRQ Version="2003A.TsabreXML1.13.1" xmlns="http://webservices.sabre.com/sabreXML/2003/07">
          <POS>
            <Source>
              <xsl:attribute name="PseudoCityCode">
                <xsl:value-of select="$PCC"/>
          ...
          <TravelerInfoSummary>
            <xsl:if test="../../POS/Source/@ISOCurrency!='' or NegoFares/PriceRequestInformation/NegotiatedFareCode/@Code!=''">
              <PriceRequestInformation>
                ...
                <xsl:if test="NegoFares/PriceRequestInformation/NegotiatedFareCode/@Code!=''">
                  <TPA_Extensions>
                    <Corporate ID="{NegoFares/PriceRequestInformation/NegotiatedFareCode/@Code}"/>
                  </TPA_Extensions>
                </xsl:if>
              </PriceRequestInformation>
            </xsl:if>
