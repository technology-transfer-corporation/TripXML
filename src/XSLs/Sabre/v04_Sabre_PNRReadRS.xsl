<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" xmlns:stl="http://services.sabre.com/STL/v01"
            ...
            <CompanyName>
              <xsl:attribute name="Code">
                <xsl:choose>
                  <xsl:when test="PriceQuote/PriceQuoteInfo/Details[1]/AgentInfo/WorkLocation">
                    <xsl:value-of select="concat(PriceQuote/PriceQuoteInfo/Details[1]/AgentInfo/WorkLocation, '|', Reservation/BookingDetails/CreationTimestamp)"/>
                  </xsl:when>
                  <xsl:otherwise>
                    <xsl:value-of select="concat(Reservation/POS/Source/@PseudoCityCode, '|', Reservation/BookingDetails/CreationTimestamp)"/>
                  </xsl:otherwise>
                </xsl:choose>
              </xsl:attribute>
              ...
              <xsl:choose>
                <xsl:when test="PNR_HDK/Line">
                  <xsl:value-of select="concat(PNR_HDK/Line[position()=last()]/@PCC, '/', Reservation/POS/Source/@AgentSine)"/>
                </xsl:when>
                <xsl:otherwise>
                  <xsl:value-of select="concat(Reservation/POS/Source/@HomePseudoCityCode, '/', Reservation/POS/Source/@AgentSine)"/>
                </xsl:otherwise>
              </xsl:choose>
            </CompanyName>
          </ItineraryRef>
  ...
  <xsl:template match="Reservation">
    ...
    <xsl:choose>
          ...
          <xsl:for-each select="OpenReservationElements/OpenReservationElement[@type='FP']/FormOfPayment/Check">
            <FormOfPayment>
              <xsl:attribute name="RPH">
                ...
                <xsl:variable name="remIndex">
                  <xsl:choose>
                    <xsl:when test="../../../../Remarks/Remark[@id=$ccid]">
                      <xsl:value-of select="../../../../Remarks/Remark[@id=$ccid]/@index"/>
                    </xsl:when>
                    <xsl:otherwise>
                      <xsl:if test="../../../../Remarks/Remark[@type='FOP']">
                        <xsl:value-of select="../../../../Remarks/Remark[@type='FOP']/@index"/>
                      </xsl:if>
                    </xsl:otherwise>
                  </xsl:choose>
                </xsl:variable>

                <xsl:value-of select="format-number($remIndex,'#0')"/>
      ...
      <xsl:when test="OpenReservationElements/OpenReservationElement[@type='FP']/FormOfPayment/PaymentCard">
          <TravelCost>
            <xsl:for-each select="OpenReservationElements/OpenReservationElement[@type='FP']">
                <FormOfPayment>
                  <xsl:attribute name="RPH">
                    <xsl:variable name="ccid">
                      <xsl:value-of select="../../@id"/>
                    ...
                    <xsl:value-of select="concat('0', format-number(../../Remarks/Remark[@type='FOP' and contains(RemarkLines/RemarkLine/Text, $cardnum)]/@index,'#0'))"/>
                  </xsl:attribute>
                  <PaymentCard>
                    <xsl:attribute name="CardCode">
                      <xsl:choose>
                        <xsl:when test="FormOfPayment/PaymentCard/CardCode='CA'">MC</xsl:when>
                        <xsl:when test="FormOfPayment/PaymentCard/CardCode='MA'">MC</xsl:when>
                        <xsl:when test="FormOfPayment/PaymentCard/CardCode='DC'">DN</xsl:when>
                        <xsl:when test="FormOfPayment/PaymentCard/CardCode='DI'">DS</xsl:when>
                        <xsl:otherwise>
                    ...
                    <xsl:attribute name="ExpireDate">
                      <xsl:value-of select="substring(FormOfPayment/PaymentCard/ExpiryMonth,3)"/>
                      <xsl:value-of select="substring(FormOfPayment/PaymentCard/ExpiryYear,3)"/>
                    </xsl:attribute>
                  </PaymentCard>
                  <TPA_Extensions>
        ...
        <xsl:if test="AccountingLines/AccountingLine">
          <xsl:for-each select="AccountingLines/AccountingLine">
            ...
            <AccountingInfo RPH="{@index}">
              ...
              <xsl:if test="AccountingVendorCode!=''">
                <AccountVendor Code="{AccountingVendorCode}"/>
              </xsl:if>
              <BaseFare>
                <xsl:choose>
              ...
              <xsl:if test="ChargeCategoryCoded!=''">
                <ChargeCategory>
                  <xsl:value-of select="ChargeCategoryCoded"/>
                </ChargeCategory>
              </xsl:if>
                      ...
                      <xsl:choose>
                        <xsl:when test="CreditCardCode!=''">
                          <PaymentCard>
                            ...
                            <xsl:attribute name="ExpireDate">
                              <xsl:choose>
                                <xsl:when test="../../../PNR_HDK_FOP[text()=$num]">
                                  <xsl:value-of select="../../../PNR_HDK_FOP[text()=$num]/@Exp"/>
                                </xsl:when>
                              </xsl:choose>
                            </xsl:attribute>
                          </PaymentCard>
  ...
  <!-- ************************************************************** -->
  <xsl:template match="TicketDetails" mode="PassangerTicketDetails">
    ...
    <xsl:variable name="tktno">
      <xsl:choose>
        <xsl:when test="contains(TicketNumber, '/')">
          <xsl:value-of select="substring-before(TicketNumber, '/')"/>
        </xsl:when>
        <xsl:otherwise>
        ...
        <xsl:when test="@ResBookDesigCode">
          ...
          <Air>
            ...
            <DepartureAirport>
              ...
              <xsl:if test="DepartureTerminalCode!=''">
                <xsl:attribute name="Terminal">
                  <xsl:value-of select="DepartureTerminalCode"/>
                </xsl:attribute>
              </xsl:if>
            </DepartureAirport>
            <ArrivalAirport>
              ...
              <xsl:if test="ArrivalTerminalCode!=''">
                <xsl:attribute name="Terminal">
                  <xsl:value-of select="ArrivalTerminalCode"/>
                </xsl:attribute>
              </xsl:if>
            </ArrivalAirport>
            <OperatingAirline>
            ...
            <xsl:if test="MarriageGrp/Group!='' and MarriageGrp/Sequence!='0'">
              <MarriageGrp>
                <xsl:value-of select="concat('00', MarriageGrp/Group)"/>
              </MarriageGrp>
            </xsl:if>
            <TPA_Extensions>
            ...
            <xsl:if test="HiddenStop">
              <StopInfo>
                <xsl:attribute name="LocationCode">
                  <xsl:value-of select="HiddenStop/@Airport"/>
                </xsl:attribute>
                <xsl:attribute name="ArrivalDateTime">
                  <xsl:value-of select="HiddenStop/ArrivalDateTime"/>
                </xsl:attribute>
                <xsl:attribute name="DepartureDateTime">
                  <xsl:value-of select="HiddenStop/DepartureDateTime"/>
                </xsl:attribute>
              </StopInfo>
            </xsl:if>
          </Air>
      ...
      <PTC_FareBreakdown>
        ...
        <PassengerFare>
          <BaseFare>
            <xsl:choose>
              <xsl:when test="FareInfo/EquivalentFare!=''">
                <xsl:attribute name="Amount">
                  <xsl:value-of select="translate(string(FareInfo/EquivalentFare),'.','')"/>
                </xsl:attribute>
                <xsl:attribute name="DecimalPlaces">
              ...
              <xsl:otherwise>
                <xsl:attribute name="Amount">
                  <xsl:value-of select="translate(string(FareInfo/BaseFare),'.','')"/>
                </xsl:attribute>
                <xsl:attribute name="DecimalPlaces">
                  <xsl:value-of select="$dect1"/>
                </xsl:attribute>
          ...
          <Taxes>
            <Tax>
                <xsl:attribute name="Amount">
                  <xsl:value-of select="translate(string(FareInfo/TotalTax),'.','') * $nip"/>
                </xsl:attribute>
				<xsl:attribute name="DecimalPlaces">
				  <xsl:value-of select="string-length(substring-after(FareInfo/TotalTax,'.'))"/>
			    </xsl:attribute>
				<xsl:attribute name="CurrencyCode">
				  <xsl:value-of select="FareInfo/TotalTax/@currencyCode"/>
			    </xsl:attribute>
            </Tax>
          </Taxes>
          <TotalFare>
            <xsl:choose>
              <xsl:when test="FareInfo/TotalFare">
                <xsl:attribute name="Amount">
                  <xsl:value-of select="translate(string(FareInfo/TotalFare),'.','')"/>
                </xsl:attribute>
                <xsl:attribute name="DecimalPlaces">
                  <xsl:value-of select="$dect1"/>
                </xsl:attribute>
        ...
        <TPA_Extensions>
          ...
          <xsl:if test="SegmentInfo/Baggage/@type='P' or SegmentInfo/Baggage/@type='W'">
            <BagAllowance>
  ...
  <xsl:template match="OpenReservationElement" mode="SSR">
    <SpecialServiceRequest>
      ...
      <Text>
        <xsl:value-of select="ServiceRequest/FreeText"/>
      </Text>
    </SpecialServiceRequest>
  </xsl:template>
  <!-- ************************************************************** -->
	...
	<xsl:template match="FareCalculationBreakdown" mode="controllingCarrier">
		...
		<xsl:if test="string-length($airline) = 2">
			...
			<SpecialRemark>
				...
				<FlightRefNumber>
					<xsl:attribute name="RPH">
						<xsl:for-each select="//Reservation/PassengerReservation/Segments/Segment[Air]">
							<xsl:variable name="flt">
								<xsl:choose>
									<xsl:when test="count(Air) > 1">
										<xsl:value-of select="concat(Air[1]/DepartureAirport, FlightSegment[last()]/ArrivalAirport)" />
									</xsl:when>
									<xsl:otherwise>
										<xsl:value-of select="concat(Air/DepartureAirport, Air/ArrivalAirport)" />
									</xsl:otherwise>
								</xsl:choose>
							</xsl:variable>
							<xsl:if test="contains($flts, $flt)">
								<xsl:variable name="rph">
									<xsl:if test="@sequence">
										<xsl:value-of select="format-number(./@sequence,'#')"/>
									</xsl:if>
								</xsl:variable>
								<!--<xsl:if test="position() > 1">
									<xsl:text> </xsl:text>
