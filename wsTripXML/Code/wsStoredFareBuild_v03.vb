...
Namespace wsTravelTalk
    ...
    <System.Web.Services.WebService(Namespace:="http://tripxml.downtowntravel.com/tripxml/wsStoredFareBuild", _
        Name:="wsStoredFareBuild_v03", _
        Description:="A TripXML Web Service to Process Stored Fare Build version v03 Messages Request.")> _
    Public Class wsStoredFareBuild_v03
...
#Region " Web Methods "
        ...
        Public Function wmStoredFareBuild(ByVal OTA_StoredFareBuildRQ As wmStoredFareBuildIn.OTA_StoredFareBuildRQ) As <XmlElementAttribute("OTA_StoredFareBuildRS")> wmStoredFareBuildOut_v03.OTA_StoredFareBuildRS
            Dim xmlMessage As String = ""
            Dim oStoredFareBuildRS As wmStoredFareBuildOut_v03.OTA_StoredFareBuildRS = Nothing
            ...
            Try
                oSerializer = Nothing
                oSerializer = New XmlSerializer(Type:=GetType(wmStoredFareBuildOut_v03.OTA_StoredFareBuildRS))
                oReader = New System.IO.StringReader(xmlMessage)
                oStoredFareBuildRS = CType(oSerializer.Deserialize(oReader), wmStoredFareBuildOut_v03.OTA_StoredFareBuildRS)
            Catch ex As Exception
