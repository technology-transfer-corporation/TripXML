...
Namespace wsTravelTalk.wmCruiseSailAvailIn
    ...
    Public Class CruiseLinePrefs
        ...
        '<remarks/>
        <System.Xml.Serialization.XmlElementAttribute("CruiseLinePref")> _
        Public CruiseLinePref() As CruiseLinePref
    End Class
    ...
    Public Class GuestCounts
        ...
        '<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()> _
        Public GroupIndicator As String
    End Class
    ...
    Public Class OTA_CruiseSailAvailRQ
        ...
        '<remarks/>
        Public SailingDateRange As SailingDateRange

        '<remarks/>
        <System.Xml.Serialization.XmlArrayItemAttribute(IsNullable:=False)> _
        Public CruiseLinePrefs() As CruiseLinePref

        '<remarks/>
        <System.Xml.Serialization.XmlElementAttribute("RegionPref")> _
        Public RegionPref() As RegionPref
    ...
    Public Class SailingDateRange
        ...
        '<remarks/>
        <System.Xml.Serialization.XmlElementAttribute("DateWindowRange", GetType(DateWindowRange)), _
         System.Xml.Serialization.XmlElementAttribute("StartDateWindow", GetType(StartDateWindow)), _
         System.Xml.Serialization.XmlElementAttribute("EndDateWindow", GetType(EndDateWindow))> _
        ...
        '<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()> _
        Public MinDuration As String

        '<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()> _
        Public MaxDuration As String

        '<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()> _
        Public ListOfDurations As String
    End Class
