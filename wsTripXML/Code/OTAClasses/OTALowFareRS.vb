...
'
Namespace wsTravelTalk.wmLowFareOut
    ...
    Public Class OTA_AirLowFareSearchRS
        ...
        Public Target As OTA_AirLowFareSearchRSTarget = OTA_AirLowFareSearchRSTarget.Production
        ...
        '<remarks/>
        <System.Xml.Serialization.XmlAttributeAttribute()> _
        Public TransactionStatusCode As OTA_AirLowFareSearchRSTransactionStatusCode
