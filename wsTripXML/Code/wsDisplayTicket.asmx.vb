...
#Region " Web Methods "
        ...
        Public Function wmDisplayTicket(ByVal TT_DisplayTicketRQ As wmDisplayTicketIn.TT_DisplayTicketRQ) As <XmlElementAttribute("TT_DisplayTicketRS")> wmDisplayTicketOut.TT_DisplayTicketRS
            Dim xmlMessage As String = ""
            Dim oDisplayTicketRS As wmDisplayTicketOut.TT_DisplayTicketRS = Nothing
            ...
            Try
                oSerializer = Nothing
                oSerializer = New XmlSerializer(Type:=GetType(wmDisplayTicketOut.TT_DisplayTicketRS))
                oReader = New System.IO.StringReader(xmlMessage)
                oDisplayTicketRS = CType(oSerializer.Deserialize(oReader), wmDisplayTicketOut.TT_DisplayTicketRS)
            Catch ex As Exception
