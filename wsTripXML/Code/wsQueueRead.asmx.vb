...
#Region " Web Methods "
        ...
        Public Function wmQueueRead(ByVal OTA_QueueReadRQ As wmQueueReadIn.OTA_QueueReadRQ) As <XmlElementAttribute("OTA_TravelItineraryRS")> wmTravelItineraryOut_v03.OTA_TravelItineraryRS
            ...
            If xmlMessage.Contains("Object reference not set to an instance of an object") Then
            ...
            Catch ex As Exception
                ...
                If oRoot.SelectSingleNode("TravelItinerary/ItineraryRef")?.OuterXml Is Nothing Then
                ...
                If oRoot.SelectSingleNode("TravelItinerary/CustomerInfos")?.OuterXml Is Nothing Then
                ...
                If oRoot.SelectSingleNode("TravelItinerary/TPA_Extensions")?.OuterXml Is Nothing Then
