...
Namespace wsTravelTalk
    ...
    <System.Web.Services.WebService(Namespace:="http://tripxml.downtowntravel.com/tripxml/wsFareInfo", _
        Name:="wsFareInfo", _
        Description:="A TripXML Web Service to Process Air Fare Info Messages Request.")> _
    Public Class wsFareInfo
...
#Region " Process Service Request All GDS "
        ...
        Private Function ServiceRequest(ByVal strRequest As String, ByVal ttServiceID As Integer) As String
            ...
            Finally
                ...
                If Trace Then CoreLib.SendTrace(ttCredential.UserID, "wsFareInfo", "============= OTA Response ============= ", strResponse, UUID)
            End Try
            sb = Nothing
            Return strResponse
...
#Region " Web Methods "
        ...
        Public Function wmFareInfo(ByVal OTA_AirFareInfoRQ As wmFareInfoIn.OTA_AirFareInfoRQ) As <XmlElementAttribute("OTA_AirFareInfoRS")> wmFareInfoOut.OTA_AirFareInfoRS
            Dim xmlMessage As String = ""
            Dim oFareInfoRS As wmFareInfoOut.OTA_AirFareInfoRS = Nothing
            Dim oSerializer As XmlSerializer = Nothing
            Dim oWriter As System.IO.StringWriter = Nothing
            Dim oReader As System.IO.StringReader = Nothing

            oSerializer = New XmlSerializer(GetType(wmFareInfoIn.OTA_AirFareInfoRQ))
            ...
            Try
                oSerializer = Nothing
                oSerializer = New XmlSerializer(Type:=GetType(wmFareInfoOut.OTA_AirFareInfoRS))
                oReader = New System.IO.StringReader(xmlMessage)
                oFareInfoRS = CType(oSerializer.Deserialize(oReader), wmFareInfoOut.OTA_AirFareInfoRS)
            Catch ex As Exception
        ...
        Public Function wmFareInfoXml(ByVal xmlRequest As String) As String
